...
var Io = (r, e, t) => e in r ? Po(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var C = (r, e, t) => Io(r, typeof e != "symbol" ? e + "" : e, t), Di = (r, e, t) => e.has(r) || Ks("Cannot " + t);
var w = (r, e, t) => (Di(r, e, "read from private field"), t ? t.call(r) : e.get(r)), j = (r, e, t) => e.has(r) ? Ks("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(r) : e.set(r, t), O = (r, e, t, i) => (Di(r, e, "write to private field"), i ? i.call(r, t) : e.set(r, t), t), Z = (r, e, t) => (Di(r, e, "access private method"), t);
import { isRef as Yn, unref as At, hasInjectionContext as No, inject as _s, getCurrentScope as _o, computed as Jn, shallowReactive as Vo, reactive as Bo, watch as ht, onScopeDispose as Wo, shallowReadonly as jo, readonly as Go, toRefs as Uo, defineComponent as $o, ref as de, nextTick as ii, onMounted as qo, onBeforeUnmount as Zo, resolveComponent as Yo, createElementBlock as re, openBlock as te, createElementVNode as z, createCommentVNode as Ft, Fragment as Li, renderList as Oi, normalizeClass as Jo, toDisplayString as Le, createTextVNode as Fi, createBlock as Xo, withCtx as Ko, withModifiers as Qs, withDirectives as en, vModelCheckbox as Qo, vModelText as ea } from "vue";
...
const E = "numeric", Ee = "short", fe = "long", pi = {
  year: E,
  month: E,
  day: E
}, Kn = {
...
function ha(r, e) {
  ...
  for (let s = 0; s < t.length; s++) {
    const { type: n, value: o } = t[s], a = aa[n];
    n === "era" ? i[a] = o : T(a) || (i[a] = parseInt(o, 10));
  }
  return i;
}
...
class De extends Jt {
  ...
  static create(e) {
    let t = Hi.get(e);
    return t === void 0 && Hi.set(e, t = new De(e)), t;
  }
  /**
  ...
  offset(e) {
    ...
    const i = oa(this.name);
    let [s, n, o, a, l, h, u] = i.formatToParts ? ha(i, t) : la(i, t);
    a === "BC" && (s = -Math.abs(s) + 1);
    const c = Ci({
      year: s,
      month: n,
    ...
    let f = +t;
    const p = f % 1e3;
    return f -= p >= 0 ? p : 1e3 + p, (c - f) / (60 * 1e3);
  }
  /**
   * Return whether this Zone is equal to another zone
   * @override
...
function ua(r, e = {}) {
  ...
  let i = tn[t];
  return i || (i = new Intl.ListFormat(r, e), tn[t] = i), i;
}
const Ui = /* @__PURE__ */ new Map();
function $i(r, e = {}) {
  const t = JSON.stringify([r, e]);
  let i = Ui.get(t);
  return i === void 0 && (i = new Intl.DateTimeFormat(r, e), Ui.set(t, i)), i;
}
const qi = /* @__PURE__ */ new Map();
function da(r, e = {}) {
  const t = JSON.stringify([r, e]);
  let i = qi.get(t);
  return i === void 0 && (i = new Intl.NumberFormat(r, e), qi.set(t, i)), i;
}
const Zi = /* @__PURE__ */ new Map();
function ca(r, e = {}) {
  const { base: t, ...i } = e, s = JSON.stringify([r, i]);
  let n = Zi.get(s);
  return n === void 0 && (n = new Intl.RelativeTimeFormat(r, e), Zi.set(s, n)), n;
}
let Pt = null;
function fa() {
...
function br(r) {
  let e = Yi.get(r);
  return e === void 0 && (e = new Intl.DateTimeFormat(r).resolvedOptions(), Yi.set(r, e)), e;
}
...
function pa(r) {
  ...
  if (!e) {
    ...
    e = "getWeekInfo" in t ? t.getWeekInfo() : t.weekInfo, "minimalDays" in e || (e = { ...vr, ...e }), Ji.set(r, e);
  }
  return e;
}
function ma(r) {
    ...
    return [r];
  {
    let i, s;
    try {
      i = $i(r).resolvedOptions(), s = r;
    } catch {
      const l = r.substring(0, t);
      i = $i(l).resolvedOptions(), s = l;
    }
...
function wa(r) {
  return r.numberingSystem && r.numberingSystem !== "latn" ? !1 : r.numberingSystem === "latn" || !r.locale || r.locale.startsWith("en") || br(r.locale).numberingSystem === "latn";
}
class ya {
  constructor(e, t, i) {
    ...
    if (!t || Object.keys(o).length > 0) {
      ...
      i.padTo > 0 && (a.minimumIntegerDigits = i.padTo), this.inf = da(e, a);
    }
  }
  format(e) {
    if (this.inf) {
...
class Ca {
  constructor(e, t, i) {
    ...
    if (this.opts.timeZone)
      ...
      e.offset !== 0 && De.create(a).valid ? (s = a, this.dt = e) : (s = "UTC", this.dt = e.offset === 0 ? e : e.setZone("UTC").plus({ minutes: e.offset }), this.originalZone = e.zone);
    ...
    const n = { ...this.opts };
    n.timeZone = n.timeZone || s, this.dtf = $i(t, n);
  }
  format() {
...
class Ea {
  constructor(e, t, i) {
    this.opts = { style: "long", ...i }, !t && kr() && (this.rtf = ca(e, i));
  }
  format(e, t) {
    return this.rtf ? this.rtf.format(e, t) : Ga(t, e, this.opts.numeric, this.opts.style !== "long");
  }
  formatToParts(e, t) {
...
class _ {
  ...
  static create(e, t, i, s, n = !1) {
    const o = e || $.defaultLocale, a = o || (n ? "en-US" : fa()), l = t || $.defaultNumberingSystem, h = i || $.defaultOutputCalendar, u = Ki(s) || $.defaultWeekSettings;
    return new _(a, l, h, u, o);
  }
  static resetCache() {
    Pt = null, Ui.clear(), qi.clear(), Zi.clear(), Yi.clear(), Ji.clear();
  }
  static fromObject({ locale: e, numberingSystem: t, outputCalendar: i, weekSettings: s } = {}) {
    return _.create(e, t, i, s);
  }
  constructor(e, t, i, s, n) {
    const [o, a, l] = ma(e);
    this.locale = o, this.numberingSystem = t || a || null, this.outputCalendar = i || l || null, this.weekSettings = s, this.intl = ga(this.locale, this.numberingSystem, this.outputCalendar), this.weekdaysCache = { format: {}, standalone: {} }, this.monthsCache = { format: {}, standalone: {} }, this.meridiemCache = null, this.eraCache = {}, this.specifiedLocale = n, this.fastNumbersCached = null;
  }
  get fastNumbers() {
    return this.fastNumbersCached == null && (this.fastNumbersCached = wa(this)), this.fastNumbersCached;
  }
  listingMode() {
  ...
  clone(e) {
    return !e || Object.getOwnPropertyNames(e).length === 0 ? this : _.create(
      ...
      Ki(e.weekSettings) || this.weekSettings,
      e.defaultToEN || !1
    );
  }
  redefaultToEN(e = {}) {
  ...
  weekdays(e, t = !1) {
    return si(this, e, zr, () => {
      ...
      return this.weekdaysCache[s][e] || (this.weekdaysCache[s][e] = va(
  ...
  relFormatter(e = {}) {
    return new Ea(this.intl, this.isEnglish(), e);
  }
  listFormatter(e = {}) {
  ...
  getWeekSettings() {
    return this.weekSettings ? this.weekSettings : xr() ? pa(this.locale) : vr;
  }
  getStartOfWeek() {
...
function _e(r, e) {
  ...
  if (Da(r)) {
    ...
    return t === "default" ? e : t === "local" || t === "system" ? wi.instance : t === "utc" || t === "gmt" ? se.utcInstance : se.parseSpecifier(t) || De.create(r);
  } else return Ge(r) ? se.instance(r) : typeof r == "object" && "offset" in r && typeof r.offset == "function" ? r : new Ra(r);
}
const Vs = {
  arab: "[٠-٩]",
  arabext: "[۰-۹]",
...
function be({ numberingSystem: r }, e = "") {
  const t = r || "latn";
  let i = Xi.get(t);
  i === void 0 && (i = /* @__PURE__ */ new Map(), Xi.set(t, i));
  let s = i.get(e);
  return s === void 0 && (s = new RegExp(`${Vs[t]}${e}`), i.set(e, s)), s;
}
let nn = () => Date.now(), rn = "system", on = null, an = null, ln = null, hn = 60, un, dn = null;
class $ {
  /**
   ...
   */
  static resetCaches() {
    _.resetCache(), De.resetCache(), k.resetCache(), xa();
  }
}
class Ce {
  constructor(e, t) {
...
const wr = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], yr = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335];
function me(r, e) {
  return new Ce(
    "unit out of range",
...
function Cr(r, e, t) {
  return t + (Xt(r) ? yr : wr)[e - 1];
}
function Er(r, e) {
  const t = Xt(r) ? yr : wr, i = t.findIndex((n) => n < e), s = e - t[i];
...
function mi(r, e = 4, t = 1) {
  const { year: i, month: s, day: n } = r, o = Cr(i, s, n), a = Ws(Bs(i, s, n), t);
  let l = Math.floor((o - a + 14 - e) / 7), h;
  return l < 1 ? (h = i - 1, l = qt(h, e, t)) : l > qt(i, e, t) ? (h = i + 1, l = 1) : h = i, { weekYear: h, weekNumber: l, weekday: a, ...Ri(r) };
}
function cn(r, e = 4, t = 1) {
  const { weekYear: i, weekNumber: s, weekday: n } = r, o = Ws(Bs(i, 1, e), t), a = gt(i);
  let l = s * 7 + n - o - 7 + e, h;
  l < 1 ? (h = i - 1, l += gt(h)) : l > a ? (h = i + 1, l -= gt(i)) : h = i;
  const { month: u, day: d } = Er(h, l);
  return { year: h, month: u, day: d, ...Ri(r) };
}
function Pi(r) {
  const { year: e, month: t, day: i } = r, s = Cr(e, t, i);
  return { year: e, ordinal: s, ...Ri(r) };
}
function fn(r) {
  const { year: e, ordinal: t } = r, { month: i, day: s } = Er(e, t);
  return { year: e, month: i, day: s, ...Ri(r) };
}
function pn(r, e) {
  if (!T(r.localWeekday) || !T(r.localWeekNumber) || !T(r.localWeekYear)) {
    if (!T(r.weekday) || !T(r.weekNumber) || !T(r.weekYear))
      throw new ut(
        "Cannot mix locale-based week fields with ISO-based week fields"
      );
    return T(r.localWeekday) || (r.weekday = r.localWeekday), T(r.localWeekNumber) || (r.weekNumber = r.localWeekNumber), T(r.localWeekYear) || (r.weekYear = r.localWeekYear), delete r.localWeekday, delete r.localWeekNumber, delete r.localWeekYear, {
...
function Ma(r, e = 4, t = 1) {
  const i = yi(r.weekYear), s = ge(
    r.weekNumber,
    1,
    qt(r.weekYear, e, t)
  ), n = ge(r.weekday, 1, 7);
  return i ? s ? n ? !1 : me("weekday", r.weekday) : me("week", r.weekNumber) : me("weekYear", r.weekYear);
}
function Sa(r) {
  const e = yi(r.year), t = ge(r.ordinal, 1, gt(r.year));
  return e ? t ? !1 : me("ordinal", r.ordinal) : me("year", r.year);
}
function Rr(r) {
  const e = yi(r.year), t = ge(r.month, 1, 12), i = ge(r.day, 1, gi(r.year, r.month));
  return e ? t ? i ? !1 : me("day", r.day) : me("month", r.month) : me("year", r.year);
}
function Tr(r) {
  const { hour: e, minute: t, second: i, millisecond: s } = r, n = ge(e, 0, 23) || e === 24 && t === 0 && i === 0 && s === 0, o = ge(t, 0, 59), a = ge(i, 0, 59), l = ge(s, 0, 999);
  return n ? o ? a ? l ? !1 : me("millisecond", s) : me("second", i) : me("minute", t) : me("hour", e);
}
function T(r) {
  return typeof r > "u";
}
...
function gi(r, e) {
  const t = za(e - 1, 12) + 1, i = r + (e - t) / 12;
  return t === 2 ? Xt(i) ? 29 : 28 : [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][t - 1];
}
function Ci(r) {
  let e = Date.UTC(
    r.year,
...
function gn(r, e, t) {
  return -Ws(Bs(r, 1, e), t) + e - 1;
}
function qt(r, e = 4, t = 1) {
  const i = gn(r, e, t), s = gn(r + 1, e, t);
  return (gt(r) - i + s) / 7;
}
function Qi(r) {
  return r > 99 ? r : r > $.twoDigitCutoffYear ? 1900 + r : 2e3 + r;
}
function Mr(r, e, t, i = null) {
...
function Ri(r) {
  return Fa(r, ["hour", "minute", "second", "millisecond"]);
}
const Ha = [
  "January",
  "February",
...
const Or = [
  ...
  "Saturday",
  "Sunday"
], Fr = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], Pa = ["M", "T", "W", "T", "F", "S", "S"];
function zr(r) {
  switch (r) {
    case "narrow":
      return [...Pa];
...
const Hr = ["AM", "PM"], Ia = ["Before Christ", "Anno Domini"], Na = ["BC", "AD"], _a = ["B", "A"];
function Ar(r) {
  switch (r) {
    case "narrow":
      return [..._a];
...
function Va(r) {
  return Hr[r.hour < 12 ? 0 : 1];
}
function Ba(r, e) {
  return zr(e)[r.weekday - 1];
}
function Wa(r, e) {
  return Lr(e)[r.month - 1];
}
function ja(r, e) {
  return Ar(e)[r.year < 0 ? 0 : 1];
}
function Ga(r, e, t = "always", i = !1) {
  const s = {
    years: ["year", "yr."],
...
class ee {
  ...
  formatDateTimeFromString(e, t) {
    const i = this.loc.listingMode() === "en", s = this.loc.outputCalendar && this.loc.outputCalendar !== "gregory", n = (f, p) => this.loc.extract(e, f, p), o = (f) => e.isOffsetFixed && e.offset === 0 && f.allowZ ? "Z" : e.isValid ? e.zone.formatOffset(e.ts, f.format) : "", a = () => i ? Va(e) : n({ hour: "numeric", hourCycle: "h12" }, "dayperiod"), l = (f, p) => i ? Wa(e, f) : n(p ? { month: f } : { month: f, day: "numeric" }, "month"), h = (f, p) => i ? Ba(e, f) : n(
      p ? { weekday: f } : { weekday: f, month: "long", day: "numeric" },
      "weekday"
    ), u = (f) => {
      const p = ee.macroTokenToFormatOpts(f);
      return p ? this.formatWithSystemDefault(e, p) : f;
    }, d = (f) => i ? ja(e, f) : n({ era: f }, "era"), c = (f) => {
      switch (f) {
        case "S":
  ...
  formatDurationFromString(e, t) {
    const i = this.opts.signMode === "negativeLargestOnly" ? -1 : 1, s = (u) => {
      ...
      const f = s(c);
      if (f) {
        const p = d.isNegativeDuration && f !== d.largestUnit ? i : 1;
        let m;
        return this.opts.signMode === "negativeLargestOnly" && f !== d.largestUnit ? m = "never" : this.opts.signMode === "all" ? m = "always" : m = "auto", this.num(u.get(f) * p, c.length, m);
      } else
        return c;
    }, o = ee.parseFormat(t), a = o.reduce(
...
const Nr = /(?:([Zz])|([+-]\d\d)(?::?(\d\d))?)/, $a = `(?:${Nr.source}?(?:\\[(${Pr.source})\\])?)?`, Us = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/, _r = RegExp(`${Us.source}${$a}`), $s = RegExp(`(?:[Tt]${_r.source})?`), qa = /([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, Za = /(\d{4})-?W(\d\d)(?:-?(\d))?/, Ya = /(\d{4})-?(\d{3})/, Ja = Ir("weekYear", "weekNumber", "weekDay"), Xa = Ir("year", "ordinal"), Ka = /(\d{4})-(\d\d)-(\d\d)/, Vr = RegExp(
  `${Us.source} ?(?:${Nr.source}|(${Pr.source}))?`
), Qa = RegExp(`(?: ${Vr.source})?`);
function bt(r, e, t) {
  const i = r[e];
  return T(i) ? t : Fe(i);
...
function Dt(r, e) {
  return [{
    ...
    minutes: bt(r, e + 1, 0),
    seconds: bt(r, e + 2, 0),
    milliseconds: js(r[e + 3])
  }, null, e + 4];
}
function Kt(r, e) {
  const t = !r[e] && !r[e + 1], i = Ei(r[e + 1], r[e + 2]), s = t ? null : se.instance(i);
  return [{}, s, e + 3];
}
function Qt(r, e) {
  const t = r[e] ? De.create(r[e]) : null;
  return [{}, t, e + 1];
}
const tl = RegExp(`^T?${Us.source}$`), il = /^-?P(?:(?:(-?\d{1,20}(?:\.\d{1,20})?)Y)?(?:(-?\d{1,20}(?:\.\d{1,20})?)M)?(?:(-?\d{1,20}(?:\.\d{1,20})?)W)?(?:(-?\d{1,20}(?:\.\d{1,20})?)D)?(?:T(?:(-?\d{1,20}(?:\.\d{1,20})?)H)?(?:(-?\d{1,20}(?:\.\d{1,20})?)M)?(?:(-?\d{1,20})(?:[.,](-?\d{1,20}))?S)?)?)$/;
function sl(r) {
  const [e, t, i, s, n, o, a, l, h] = r, u = e[0] === "-", d = l && l[0] === "-", c = (f, p = !1) => f !== void 0 && (p || f && u) ? -f : f;
  return [
    {
      years: c(qe(t)),
      months: c(qe(i)),
...
function qs(r, e, t, i, s, n, o) {
  const a = {
    year: e.length === 2 ? Qi(Fe(e)) : Fe(e),
    month: Dr.indexOf(t) + 1,
    day: Fe(i),
    hour: Fe(s),
    minute: Fe(n)
  };
  return o && (a.second = Fe(o)), r && (a.weekday = r.length > 3 ? Or.indexOf(r) + 1 : Fr.indexOf(r) + 1), a;
}
const rl = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|(?:([+-]\d\d)(\d\d)))$/;
function ol(r) {
  const [
    ,
    e,
    ...
    u,
    d
  ] = r, c = qs(e, s, i, t, n, o, a);
  let f;
  return l ? f = nl[l] : h ? f = 0 : f = Ei(u, d), [c, new se(f)];
}
function al(r) {
  return r.replace(/\([^()]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").trim();
}
const ll = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun), (\d\d) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (\d{4}) (\d\d):(\d\d):(\d\d) GMT$/, hl = /^(Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday), (\d\d)-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-(\d\d) (\d\d):(\d\d):(\d\d) GMT$/, ul = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) ( \d|\d\d) (\d\d):(\d\d):(\d\d) (\d{4})$/;
function vn(r) {
  const [, e, t, i, s, n, o, a] = r;
  return [qs(e, s, i, t, n, o, a), se.utcInstance];
}
function dl(r) {
  const [, e, t, i, s, n, o, a] = r;
  return [qs(e, a, t, i, s, n, o), se.utcInstance];
}
const cl = xt(qa, $s), fl = xt(Za, $s), pl = xt(Ya, $s), ml = xt(_r), Br = Mt(
  el,
  Dt,
  Kt,
  Qt
...
const kl = xt(Ka, Qa), xl = xt(Vr), Ml = Mt(
  Dt,
  Kt,
  Qt
);
...
const wn = "Invalid Duration", Wr = {
  ...
  ...Wr
}, pe = 146097 / 400, ot = 146097 / 4800, Ll = {
  years: {
    quarters: 4,
    months: 12,
    weeks: pe / 7,
...
function jr(r, e) {
  ...
  for (const i of Ol.slice(1))
    e[i] && (t += e[i] * r[i].milliseconds);
  return t;
}
function yn(r, e) {
  const t = jr(r, e) < 0 ? -1 : 1;
  Ke.reduceRight((i, s) => {
    if (T(e[s]))
      return i;
    if (i) {
...
class A {
  ...
  constructor(e) {
    ...
    let i = t ? Ll : Dl;
    e.matrix && (i = e.matrix), this.values = e.values, this.loc = e.loc || _.create(), this.conversionAccuracy = t ? "longterm" : "casual", this.invalid = e.invalid || null, this.matrix = i, this.isLuxonDuration = !0;
  }
  /**
  ...
  toFormat(e, t = {}) {
    ...
    return this.isValid ? ee.create(this.loc, i).formatDurationFromString(this, e) : wn;
  }
  /**
   ...
   */
  toHuman(e = {}) {
    if (!this.isValid) return wn;
    const t = e.showZeros !== !1, i = Ke.map((s) => {
      const n = this.values[s];
      return T(n) || n === 0 && !t ? null : this.loc.numberFormatter({ style: "unit", unitDisplay: "long", ...e, unit: s.slice(0, -1) }).format(n);
    }).filter((s) => s);
  ...
  mapUnits(e) {
    ...
    for (const i of Object.keys(this.values))
      t[i] = Sr(e(this.values[i], i));
    return ke(this, { values: t }, !0);
  }
  /**
  ...
  set(e) {
    if (!this.isValid) return this;
    const t = { ...this.values, ...bi(e, A.normalizeUnit) };
    return ke(this, { values: t });
  }
  /**
  ...
  normalize() {
    ...
    return yn(this.matrix, e), ke(this, { values: e }, !0);
  }
  /**
  ...
  rescale() {
    if (!this.isValid) return this;
    const e = Cn(this.normalize().shiftToAll().toObject());
    return ke(this, { values: e }, !0);
  }
  /**
  ...
  shiftTo(...e) {
    ...
    return yn(this.matrix, t), ke(this, { values: t }, !0);
  }
  /**
...
function Fl(r, e) {
  return !r || !r.isValid ? U.invalid("missing or invalid start") : !e || !e.isValid ? U.invalid("missing or invalid end") : e < r ? U.invalid(
    "end before start",
...
class U {
   ...
   */
  static after(e, t) {
    const i = A.fromDurationLike(t), s = zt(e);
    return U.fromDateTimes(s, s.plus(i));
  }
  /**
  ...
  static before(e, t) {
    const i = A.fromDurationLike(t), s = zt(e);
    return U.fromDateTimes(s.minus(i), s);
  }
  /**
  ...
  static fromISO(e, t) {
    ...
    if (i && s) {
      let n, o;
      try {
        n = k.fromISO(i, t), o = n.isValid;
      } catch {
        o = !1;
      }
      let a, l;
      try {
        a = k.fromISO(s, t), l = a.isValid;
      } catch {
        l = !1;
      }
      if (o && l)
        return U.fromDateTimes(n, a);
      if (o) {
   ...
   */
  set({ start: e, end: t } = {}) {
    return this.isValid ? U.fromDateTimes(e || this.s, t || this.e) : this;
  }
  /**
  ...
  splitAt(...e) {
    ...
    const t = e.map(zt).filter((o) => this.contains(o)).sort((o, a) => o.toMillis() - a.toMillis()), i = [];
    let { s } = this, n = 0;
    for (; s < this.e; ) {
      const o = t[n] || this.e, a = +o > +this.e ? this.e : o;
      i.push(U.fromDateTimes(s, a)), s = a, n += 1;
    }
    return i;
  }
  /**
  ...
  splitBy(e) {
    ...
    for (; i < this.e; ) {
      ...
      n = +a > +this.e ? this.e : a, o.push(U.fromDateTimes(i, n)), i = n, s += 1;
    }
    return o;
  }
  /**
  ...
  intersection(e) {
    ...
    return t >= i ? null : U.fromDateTimes(t, i);
  }
  /**
  ...
  static xor(e) {
    ...
    for (const l of a)
      i += l.type === "s" ? 1 : -1, i === 1 ? t = l.time : (t && +t != +l.time && s.push(U.fromDateTimes(t, l.time)), t = null);
    return U.merge(s);
  }
  /**
   ...
   */
  difference(...e) {
    return U.xor([this].concat(e)).map((t) => this.intersection(t)).filter((t) => t && !t.isEmpty());
  }
  /**
   ...
   * @return {string}
   */
  toLocaleString(e = pi, t = {}) {
    return this.isValid ? ee.create(this.s.loc.clone(t), e).formatInterval(this) : at;
  }
  /**
...
class ni {
  ...
  static months(e = "long", { locale: t = null, numberingSystem: i = null, locObj: s = null, outputCalendar: n = "gregory" } = {}) {
    return (s || _.create(t, i, n)).months(e);
  }
  /**
  ...
  static monthsFormat(e = "long", { locale: t = null, numberingSystem: i = null, locObj: s = null, outputCalendar: n = "gregory" } = {}) {
    return (s || _.create(t, i, n)).months(e, !0);
  }
  /**
  ...
  static weekdays(e = "long", { locale: t = null, numberingSystem: i = null, locObj: s = null } = {}) {
    return (s || _.create(t, i, null)).weekdays(e);
  }
  /**
  ...
  static weekdaysFormat(e = "long", { locale: t = null, numberingSystem: i = null, locObj: s = null } = {}) {
    return (s || _.create(t, i, null)).weekdays(e, !0);
  }
  /**
...
const Al = "missing Intl.DateTimeFormat.formatToParts support";
function I(r, e = (t) => t) {
  return { regex: r, deser: ([t]) => e(ka(t)) };
}
const Pl = " ", Gr = `[ ${Pl}]`, Ur = new RegExp(Gr, "g");
function Il(r) {
  return r.replace(/\./g, "\\.?").replace(Ur, Gr);
}
function Rn(r) {
...
function ve(r, e) {
  return r === null ? null : {
    regex: RegExp(r.map(Il).join("|")),
    deser: ([t]) => r.findIndex((i) => Rn(t) === Rn(i)) + e
  };
}
function Tn(r, e) {
  return { regex: r, deser: ([, t, i]) => Ei(t, i), groups: e };
}
function ri(r) {
...
function _l(r, e) {
  const t = be(e), i = be(e, "{2}"), s = be(e, "{3}"), n = be(e, "{4}"), o = be(e, "{6}"), a = be(e, "{1,2}"), l = be(e, "{1,3}"), h = be(e, "{1,6}"), u = be(e, "{1,9}"), d = be(e, "{2,4}"), c = be(e, "{4,6}"), f = (v) => ({ regex: RegExp(Nl(v.val)), deser: ([g]) => g, literal: !0 }), m = ((v) => {
    if (r.literal)
      return f(v);
    switch (v.val) {
      case "G":
      ...
      case "Z":
      case "ZZ":
        return Tn(new RegExp(`([+-]${a.source})(?::(${i.source}))?`), 2);
      case "ZZZ":
        return Tn(new RegExp(`([+-]${a.source})(${i.source})?`), 2);
      case "z":
...
function Gl(r) {
  ...
  let t = null, i;
  return T(r.z) || (t = De.create(r.z)), T(r.Z) || (t || (t = new se(r.Z)), i = r.Z), T(r.q) || (r.M = (r.q - 1) * 3 + 1), T(r.h) || (r.h < 12 && r.a === 1 ? r.h += 12 : r.h === 12 && r.a === 0 && (r.h = 0)), r.G === 0 && r.y && (r.y = -r.y), T(r.u) || (r.S = js(r.u)), [Object.keys(r).reduce((n, o) => {
    const a = e(o);
    return a && (n[a] = r[o]), n;
  }, {}), t, i];
}
let Ii = null;
function Ul() {
  return Ii || (Ii = k.fromMillis(1555555555555)), Ii;
}
function $l(r, e) {
  if (r.literal)
    return r;
  const t = ee.macroTokenToFormatOpts(r.val), i = Yr(t, e);
  return i == null || i.includes(void 0) ? r : i;
}
function $r(r, e) {
  return Array.prototype.concat(...r.map((t) => $l(t, e)));
}
class qr {
  constructor(e, t) {
    if (this.locale = e, this.format = t, this.tokens = $r(ee.parseFormat(t), e), this.units = this.tokens.map((i) => _l(i, e)), this.disqualifyingUnit = this.units.find((i) => i.invalidReason), !this.disqualifyingUnit) {
      const [i, s] = Wl(this.units);
      this.regex = RegExp(i, "i"), this.handlers = s;
    }
  }
  explainFromTokens(e) {
    if (this.isValid) {
      const [t, i] = jl(e, this.regex, this.handlers), [s, n, o] = i ? Gl(i) : [null, null, void 0];
      if (kt(i, "a") && kt(i, "H"))
        throw new ut(
...
function ql(r, e, t) {
  const { result: i, zone: s, specificOffset: n, invalidReason: o } = Zr(r, e, t);
  return [i, s, n, o];
}
function Yr(r, e) {
  if (!r)
    return null;
  const i = ee.create(e, r).dtFormatter(Ul()), s = i.formatToParts(), n = i.resolvedOptions();
  return s.map((o) => Bl(o, r, n));
}
const Ni = "Invalid DateTime", kn = 864e13;
function It(r) {
...
function xn(r, e) {
  const t = r.o, i = r.c.year + Math.trunc(e.years), s = r.c.month + Math.trunc(e.months) + Math.trunc(e.quarters) * 3, n = {
    ...
    year: i,
    month: s,
    day: Math.min(r.c.day, gi(i, s)) + Math.trunc(e.days) + Math.trunc(e.weeks) * 7
  }, o = A.fromObject({
  ...
  }).as("milliseconds"), a = Ci(n);
  let [l, h] = Jr(a, t, r.zone);
  return o !== 0 && (l += o, h = r.zone.offset(l)), { ts: l, o: h };
}
function lt(r, e, t, i, s, n) {
  const { setZone: o, zone: a } = t;
  if (r && Object.keys(r).length !== 0 || e) {
    const l = e || a, h = k.fromObject(r, {
      ...t,
      zone: l,
      specificOffset: n
    });
...
function ai(r, e, t = !0) {
  return r.isValid ? ee.create(_.create("en-US"), {
    allowZ: t,
    forceSimple: !0
...
function Bi(r, e, t) {
  ...
  let s = "";
  if (i && r.c.year >= 0 && (s += "+"), s += Y(r.c.year, i ? 6 : 4), t === "year") return s;
  if (e) {
    if (s += "-", s += Y(r.c.month), t === "month") return s;
    s += "-";
  } else if (s += Y(r.c.month), t === "month") return s;
  return s += Y(r.c.day), s;
}
function Mn(r, e, t, i, s, n, o) {
  ...
  switch (o) {
    ...
    case "year":
      break;
    default:
      if (l += Y(r.c.hour), o === "hour") break;
      if (e) {
        if (l += ":", l += Y(r.c.minute), o === "minute") break;
        a && (l += ":", l += Y(r.c.second));
      } else {
        if (l += Y(r.c.minute), o === "minute") break;
        a && (l += Y(r.c.second));
      }
      if (o === "second") break;
      a && (!i || r.c.millisecond !== 0) && (l += ".", l += Y(r.c.millisecond, 3));
  }
  return s && (r.isOffsetFixed && r.offset === 0 && !n ? l += "Z" : r.o < 0 ? (l += "-", l += Y(Math.trunc(-r.o / 60)), l += ":", l += Y(Math.trunc(-r.o % 60))) : (l += "+", l += Y(Math.trunc(r.o / 60)), l += ":", l += Y(Math.trunc(r.o % 60)))), n && (l += "[" + r.zone.ianaName + "]"), l;
}
const Xr = {
  month: 1,
  day: 1,
  ...
  second: 0,
  millisecond: 0
}, ui = ["year", "month", "day", "hour", "minute", "second", "millisecond"], Jl = [
  "weekYear",
  "weekNumber",
  "weekday",
  "hour",
...
function Kl(r) {
  if (Nt === void 0 && (Nt = $.now()), r.type !== "iana")
    return r.offset(Nt);
  const e = r.name;
  let t = es.get(e);
  return t === void 0 && (t = r.offset(Nt), es.set(e, t)), t;
}
function Dn(r, e) {
  const t = _e(e.zone, $.defaultZone);
  if (!t.isValid)
    return k.invalid(It(t));
  const i = _.fromObject(e);
  let s, n;
  if (T(r.year))
    s = $.now();
  else {
  ...
  return new k({ ts: s, zone: t, loc: i, o: n });
}
function Ln(r, e, t) {
  const i = T(t.round) ? !0 : t.round, s = T(t.rounding) ? "trunc" : t.rounding, n = (a, l) => (a = Gs(a, i || t.calendary ? 0 : 2, t.calendary ? "round" : s), e.loc.clone(t).relFormatter(t).format(a, l)), o = (a) => t.calendary ? e.hasSame(r, a) ? 0 : e.startOf(a).diff(r.startOf(a), a).get(a) : e.diff(r, a).get(a);
  if (t.unit)
...
class k {
   ...
   */
  constructor(e) {
    const t = e.zone || $.defaultZone;
    let i = e.invalid || (Number.isNaN(e.ts) ? new Ce("invalid input") : null) || (t.isValid ? null : It(t));
    this.ts = T(e.ts) ? $.now() : e.ts;
    let s = null, n = null;
    if (!i)
      if (e.old && e.old.ts === this.ts && e.old.zone.equals(t))
        [s, n] = [e.old.c, e.old.o];
      else {
        const a = Ge(e.o) && !e.old ? e.o : t.offset(this.ts);
        s = oi(this.ts, a), i = Number.isNaN(s.year) ? new Ce("invalid input") : null, s = i ? null : s, n = i ? null : a;
      }
    this._zone = t, this.loc = e.loc || _.create(), this.invalid = i, this.weekData = null, this.localWeekData = null, this.c = s, this.o = n, this.isLuxonDateTime = !0;
  }
  // CONSTRUCT
  /**
   ...
   */
  static local() {
    const [e, t] = On(arguments), [i, s, n, o, a, l, h] = t;
    return Dn({ year: i, month: s, day: n, hour: o, minute: a, second: l, millisecond: h }, e);
  }
  /**
  ...
  static utc() {
    const [e, t] = On(arguments), [i, s, n, o, a, l, h] = t;
    return e.zone = se.utcInstance, Dn({ year: i, month: s, day: n, hour: o, minute: a, second: l, millisecond: h }, e);
  }
  /**
  ...
  static fromJSDate(e, t = {}) {
    const i = La(e) ? e.valueOf() : NaN;
    if (Number.isNaN(i))
      return k.invalid("invalid input");
    const s = _e(t.zone, $.defaultZone);
  ...
  static fromMillis(e, t = {}) {
    if (Ge(e))
      return e < -kn || e > kn ? k.invalid("Timestamp out of range") : new k({
        ts: e,
        zone: _e(t.zone, $.defaultZone),
        loc: _.fromObject(t)
      });
    throw new K(
  ...
  static fromObject(e, t = {}) {
    e = e || {};
    const i = _e(t.zone, $.defaultZone);
    if (!i.isValid)
      return k.invalid(It(i));
    const s = _.fromObject(t), n = bi(e, Sn), { minDaysInFirstWeek: o, startOfWeek: a } = pn(n, s), l = $.now(), h = T(t.specificOffset) ? i.offset(l) : t.specificOffset, u = !T(n.ordinal), d = !T(n.year), c = !T(n.month) || !T(n.day), f = d || c, p = n.weekYear || n.weekNumber;
    if ((f || u) && p)
      throw new ut(
    ...
    const m = p || n.weekday && !f;
    let v, g, R = oi(l, h);
    m ? (v = Jl, g = Zl, R = mi(R, o, a)) : u ? (v = Xl, g = Yl, R = Pi(R)) : (v = ui, g = Xr);
    let L = !1;
    for (const G of v) {
      const he = n[G];
      T(he) ? L ? n[G] = g[G] : n[G] = R[G] : L = !0;
    }
    const P = m ? Ma(n, o, a) : u ? Sa(n) : Rr(n), H = P || Tr(n);
    if (H)
      return k.invalid(H);
    const q = m ? cn(n, o, a) : u ? fn(n) : n, [le, N] = hi(q, h, i), ne = new k({
      ts: le,
      zone: i,
      o: N,
      loc: s
    });
    return n.weekday && f && e.weekday !== ne.weekday ? k.invalid(
      "mismatched weekday",
      `you can't specify both a weekday of ${n.weekday} and a date of ${ne.toISO()}`
  ...
  static fromFormat(e, t, i = {}) {
    ...
    const { locale: s = null, numberingSystem: n = null } = i, o = _.fromOpts({
      locale: s,
      numberingSystem: n,
      defaultToEN: !0
    }), [a, l, h, u] = ql(o, e, t);
    return u ? k.invalid(u) : lt(a, l, i, `format ${t}`, e, h);
  }
  /**
   * @deprecated use fromFormat instead
   */
  static fromString(e, t, i = {}) {
    return k.fromFormat(e, t, i);
  }
  /**
  ...
  static expandFormat(e, t = {}) {
    return $r(ee.parseFormat(e), _.fromObject(t)).map((s) => s.val).join("");
  }
  static resetCache() {
    Nt = void 0, es.clear();
  }
   ...
   */
  get weekYear() {
    return this.isValid ? _i(this).weekYear : NaN;
  }
  /**
   ...
   */
  get weekNumber() {
    return this.isValid ? _i(this).weekNumber : NaN;
  }
  /**
   ...
   */
  get localWeekNumber() {
    return this.isValid ? Vi(this).weekNumber : NaN;
  }
  /**
   ...
   */
  get ordinal() {
    return this.isValid ? Pi(this.c).ordinal : NaN;
  }
  /**
  ...
  getPossibleOffsets() {
    if (!this.isValid || this.isOffsetFixed)
      return [this];
    const e = 864e5, t = 6e4, i = Ci(this.c), s = this.zone.offset(i - e), n = this.zone.offset(i + e), o = this.zone.offset(i - s * t), a = this.zone.offset(i - n * t);
    if (o === a)
      return [this];
    const l = i - o * t, h = i - a * t, u = oi(l, o), d = oi(h, a);
    return u.hour === d.hour && u.minute === d.minute && u.second === d.second && u.millisecond === d.millisecond ? [Ze(this, { ts: l }), Ze(this, { ts: h })] : [this];
  }
  /**
   ...
   */
  toUTC(e = 0, t = {}) {
    return this.setZone(se.instance(e), t);
  }
  /**
  ...
  setZone(e, { keepLocalTime: t = !1, keepCalendarTime: i = !1 } = {}) {
    if (e = _e(e, $.defaultZone), e.equals(this.zone))
      return this;
    if (e.isValid) {
      let s = this.ts;
      if (t || i) {
      ...
      return Ze(this, { ts: s, zone: e });
    } else
      return k.invalid(It(e));
  }
  /**
  ...
  set(e) {
    if (!this.isValid) return this;
    const t = bi(e, Sn), { minDaysInFirstWeek: i, startOfWeek: s } = pn(t, this.loc), n = !T(t.weekYear) || !T(t.weekNumber) || !T(t.weekday), o = !T(t.ordinal), a = !T(t.year), l = !T(t.month) || !T(t.day), h = a || l, u = t.weekYear || t.weekNumber;
    if ((h || o) && u)
      throw new ut(
        "Can't mix weekYear/weekNumber units with year/month/day or ordinals"
      );
    ...
    n ? d = cn(
      ...
      i,
      s
    ) : T(t.ordinal) ? (d = { ...this.toObject(), ...t }, T(t.day) && (d.day = Math.min(gi(d.year, d.month), d.day))) : d = fn({ ...Pi(this.c), ...t });
    const [c, f] = hi(d, this.o, this.zone);
    return Ze(this, { ts: c, o: f });
  }
  /**
   ...
   */
  toFormat(e, t = {}) {
    return this.isValid ? ee.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e) : Ni;
  }
  /**
   ...
   */
  toLocaleString(e = pi, t = {}) {
    return this.isValid ? ee.create(this.loc.clone(t), e).formatDateTime(this) : Ni;
  }
  /**
  ...
  toISO({
    ...
    const a = e === "extended";
    let l = Bi(this, a, o);
    return ui.indexOf(o) >= 3 && (l += "T"), l += Mn(
      this,
      a,
      t,
      i,
  ...
  toISODate({ format: e = "extended", precision: t = "day" } = {}) {
    return this.isValid ? Bi(this, e === "extended", di(t)) : null;
  }
  /**
  ...
  toISOTime({
    ...
    return this.isValid ? (a = di(a), (s && ui.indexOf(a) >= 3 ? "T" : "") + Mn(
      this,
      o === "extended",
      t,
      e,
  ...
  toSQLTime({ includeOffset: e = !0, includeZone: t = !1, includeOffsetSpace: i = !0 } = {}) {
    let s = "HH:mm:ss.SSS";
    return (t || e) && (i && (s += " "), t ? s += "z" : e && (s += "ZZ")), ai(this, s, !0);
  }
  /**
   ...
   */
  toString() {
    return this.isValid ? this.toISO() : Ni;
  }
  /**
  ...
  diff(e, t = "milliseconds", i = {}) {
    ...
    const s = { locale: this.locale, numberingSystem: this.numberingSystem, ...i }, n = Oa(t).map(A.normalizeUnit), o = e.valueOf() > this.valueOf(), a = o ? this : e, l = o ? e : this, h = Hl(a, l, n, s);
    return o ? h.negate() : h;
  }
  /**
  ...
  toRelative(e = {}) {
    if (!this.isValid) return null;
    const t = e.base || k.fromObject({}, { zone: this.zone }), i = e.padding ? this < t ? -e.padding : e.padding : 0;
    let s = ["years", "months", "days", "hours", "minutes", "seconds"], n = e.unit;
    return Array.isArray(e.unit) && (s = e.unit, n = void 0), Ln(t, this.plus(i), {
      ...e,
      numeric: "always",
      units: s,
      unit: n
  ...
  toRelativeCalendar(e = {}) {
    return this.isValid ? Ln(e.base || k.fromObject({}, { zone: this.zone }), this, {
      ...e,
      numeric: "auto",
  ...
  static fromStringExplain(e, t, i = {}) {
    return k.fromFormatExplain(e, t, i);
  }
  /**
  ...
  static buildFormatParser(e, t = {}) {
    const { locale: i = null, numberingSystem: s = null } = t, n = _.fromOpts({
      locale: i,
      numberingSystem: s,
      defaultToEN: !0
    });
...
function zt(r) {
  if (k.isDateTime(r))
    return r;
  if (r && r.valueOf && Ge(r.valueOf()))
    return k.fromJSDate(r);
...
let Ql = class Kr extends X {
  ...
  child(e) {
    return this.childPopup && this.childPopup.hide(), this.childPopup = new Kr(this.table, e, this), this.childPopup;
  }
};
class D extends X {
  constructor(e, t) {
...
function is(r, e) {
  ...
  if (e = e || "", Array.isArray(r))
    r.forEach((s, n) => {
      t = t.concat(is(s, e ? e + "[" + n + "]" : n));
    });
  else if (typeof r == "object")
    for (var i in r)
      t = t.concat(is(r[i], e ? e + "[" + i + "]" : i));
  else
...
function Qr(r, e, t) {
  return r && t && Object.keys(t).length && (!e.method || e.method.toLowerCase() == "get") && (e.method = "get", r += (r.includes("?") ? "&" : "?") + ih(t)), r;
}
function sh(r, e, t) {
  var i;
...
function ss(r, e) {
  ...
  if (e = e || "", Array.isArray(r))
    r.forEach((s, n) => {
      t = t.concat(ss(s, e ? e + "[" + n + "]" : n));
    });
  else if (typeof r == "object")
    for (var i in r)
      t = t.concat(ss(r[i], e ? e + "[" + i + "]" : i));
  else
    t.push({ key: e, value: r });
  return t;
}
...
C(we, "defaultConfig", th), C(we, "defaultURLGenerator", Qr), C(we, "defaultLoaderPromise", sh), C(we, "contentTypeFormatters", nh);
let ns = we;
var rh = {
  replace: function(r) {
...
C(ze, "moduleName", "clipboard"), C(ze, "moduleExtensions", hh), //load defaults
C(ze, "pasteActions", rh), C(ze, "pasteParsers", oh);
let rs = ze;
class uh {
  constructor(e) {
...
const He = class He extends D {
  ...
  generateRow(e, t) {
    ...
    return this.table.modExists("mutator") && this.table.modules.mutator.disable(), s = new Q(i, this, "calc"), this.table.modExists("mutator") && this.table.modules.mutator.enable(), s.getElement().classList.add("tabulator-calcs", "tabulator-calcs-" + e), s.component = !1, s.getComponent = () => (s.component || (s.component = new uh(s)), s.component), s.generateCells = () => {
      var n = [];
...
class so extends D {
  ...
  getRows(e) {
    ...
    return e.forEach((i, s) => {
      var n, o;
      t.push(i), i instanceof Q && (i.create(), n = i.modules.dataTree, !n.index && n.children !== !1 && (o = this.getChildren(i, !1, !0), o.forEach((a) => {
        a.create(), t.push(a);
      })));
    }), t;
  }
  ...
  getTreeChildren(e, t, i) {
    ...
    return s && s.children && (Array.isArray(s.children) || (s.children = this.generateChildren(e)), s.children.forEach((o) => {
      o instanceof Q && (n.push(t ? o.getComponent() : o), i && this.getTreeChildren(o, t, i).forEach((a) => {
        n.push(a);
      }));
    })), n;
  }
...
function mh(r, e, t) {
  var i = this, s = e.sheetName || "Sheet1", n = this.dependencyRegistry.lookup("XLSX"), o = n.utils.book_new(), a = new X(this), l = "compress" in e ? e.compress : !0, h = e.writeOptions || { bookType: "xlsx", bookSST: !0, compression: l }, u;
  h.type = "binary", o.SheetNames = [], o.Sheets = {};
  function d() {
    var p = [], m = [], v = {}, g = { s: { c: 0, r: 0 }, e: { c: r[0] ? r[0].columns.reduce((R, L) => R + (L && L.width ? L.width : 1), 0) : 0, r: r.length } };
    return r.forEach((R, L) => {
      var P = [];
      R.columns.forEach(function(H, q) {
        H ? (P.push(!(H.value instanceof Date) && typeof H.value == "object" ? JSON.stringify(H.value) : H.value), (H.width > 1 || H.height > -1) && (H.height > 1 || H.width > 1) && m.push({ s: { r: L, c: q }, e: { r: L + H.height - 1, c: q + H.width - 1 } })) : P.push("");
      }), p.push(P);
    }), n.utils.sheet_add_aoa(v, p), v["!ref"] = n.utils.encode_range(g), m.length && (v["!merges"] = m), v;
  }
  if (e.sheetOnly) {
    t(d());
    return;
  ...
  function f(p) {
    for (var m = new ArrayBuffer(p.length), v = new Uint8Array(m), g = 0; g != p.length; ++g) v[g] = p.charCodeAt(g) & 255;
    return m;
  }
...
let xh = class {
  ...
  _ajaxRequest(e, t) {
    ...
    return e = Qr(e, {}, i), fetch(e).then((s) => s.ok ? s.json().catch((n) => (console.warn("List Ajax Load Error - Invalid JSON returned", n), Promise.reject(n))) : (console.error("List Ajax Load Error - Connection Error: " + s.status, s.statusText), Promise.reject(s))).catch((s) => (console.error("List Ajax Load Error - Connection Error: ", s), Promise.reject(s)));
  }
...
function Mh(r, e, t, i, s) {
  var n = new xh(this, r, e, t, i, s);
  return n.input;
}
function Sh(r, e, t, i, s) {
  ...
  for (var v = 1; v <= l; v++)
    p(v);
  return a = Math.min(parseInt(a), l), f(a), d.addEventListener("mousemove", function(g) {
    f(0);
...
function Dh(r, e, t, i, s) {
  ...
  function p() {
    var m = window.getComputedStyle(n, null), v = l * Math.round(d.offsetWidth / ((n.clientWidth - parseInt(m.getPropertyValue("padding-left")) - parseInt(m.getPropertyValue("padding-right"))) / 100)) + a;
  ...
  return n.style.padding = "4px 4px", h = Math.min(parseFloat(h), o), h = Math.max(parseFloat(h), a), h = Math.round((h - a) / l), d.style.width = h + "%", n.setAttribute("aria-valuemin", a), n.setAttribute("aria-valuemax", o), d.appendChild(u), u.addEventListener("mousedown", function(m) {
    c = m.screenX, f = d.offsetWidth;
  }), u.addEventListener("mouseover", function() {
    u.style.cursor = "ew-resize";
  }), n.addEventListener("mousemove", function(m) {
    c && (d.style.width = f + m.screenX - c + "px");
  }), n.addEventListener("mouseup", function(m) {
    c && (m.stopPropagation(), m.stopImmediatePropagation(), c = !1, f = !1, p());
  }), n.addEventListener("keydown", function(m) {
    switch (m.keyCode) {
      case 39:
        m.preventDefault(), d.style.width = d.clientWidth + n.clientWidth / 100 + "px";
        break;
      case 37:
        m.preventDefault(), d.style.width = d.clientWidth - n.clientWidth / 100 + "px";
        break;
...
function Lh(r, e, t, i, s) {
  ...
  function c(f) {
    var p = o.checked;
    return u && p ? p = s.trueValue : d && !p && (p = s.falseValue), a ? f ? h ? l : p : o.checked && !h ? (o.checked = !1, o.indeterminate = !0, h = !0, l) : (h = !1, p) : p;
  }
  ...
  edit(e, t, i) {
    ...
    function c(g) {
      if (s.currentCell === e && !l) {
        var R = s.chain("edit-success", [e, g], !0, !0);
        return R === !0 || s.table.options.validationMode === "highlight" ? (l = !0, s.clearEditor(), e.modules.edit || (e.modules.edit = {}), e.modules.edit.edited = !0, s.editedCells.indexOf(e) == -1 && s.editedCells.push(e), g = s.transformEmptyValues(g, e), e.setValue(g, !0), R === !0) : (l = !0, s.invalidEdit = !0, s.focusCellNoEvent(e, !0), o(), setTimeout(() => {
          l = !1;
        }, 10), !1);
      }
    }
    ...
    if (t && t.stopPropagation(), n = this.allowEdit(e), n || i) {
      if (s.cancelEdit(), s.currentCell = e, this.focusScrollAdjust(e), u = e.getComponent(), this.mouseClick && (this.mouseClick = !1, e.column.definition.cellClick && e.column.definition.cellClick.call(this.table, t, u)), e.column.definition.cellEditing && e.column.definition.cellEditing.call(this.table, u), this.dispatch("cell-editing", e), this.dispatchExternal("cellEditing", u), d = typeof e.column.modules.edit.params == "function" ? e.column.modules.edit.params(u) : e.column.modules.edit.params, h = e.column.modules.edit.editor.call(s, u, p, c, f, d), this.currentCell && h !== !1)
        if (h instanceof Node) {
          ...
          a.appendChild(h), o();
          for (var m = a.children, v = 0; v < m.length; v++)
            m[v].addEventListener("click", function(g) {
              g.stopPropagation();
            });
        } else
...
C(Wt, "moduleName", "edit"), //load defaults
C(Wt, "editors", Fh);
let ls = Wt;
class Fn {
  constructor(e, t, i, s) {
...
const Ae = class Ae extends D {
    ...
    return e.forEach(function(o) {
      ...
      o.forEach((l) => {
        if (l) {
          ...
          a.push(new Wi(h, l.column.getComponent(), l.width, l.height, l.depth));
        } else
          a.push(null);
  ...
  bodyToExportRows(e, t = []) {
    ...
    return t.length === 0 && this.table.columnManager.columnsByIndex.forEach((s) => {
      ...
      switch (s.type) {
        case "group":
          l = s.level, a.push(new Wi(s.key, s.getComponent(), t.length, 1));
          break;
        case "calc":
        case "row":
          t.forEach((h) => {
            a.push(new Wi(h._column.getFieldValue(o), h, 1, 1));
  ...
  generateRowElement(e, t, i) {
    ...
    if (s.classList.add("tabulator-print-table-row"), e.columns.forEach((n, o) => {
      if (n) {
        var a = document.createElement("td"), l = n.component._column, h = this.table, u = h.columnManager.findColumnIndex(l), d = n.value, c, f, p = {
          modules: {},
          getValue: function() {
            return d;
          },
...
C(Ae, "moduleName", "export"), C(Ae, "columnLookups", zh), C(Ae, "rowLookups", Hh);
let hs = Ae;
var Ah = {
  //equal to
  "=": function(r, e, t, i) {
...
const xe = class xe extends D {
      ...
      if (typeof e.modules.filter.prevSuccess > "u" || e.modules.filter.prevSuccess !== o) {
        if (e.modules.filter.prevSuccess = o, e.modules.filter.emptyFunc(o))
          ...
          switch (e.modules.filter.value = o, typeof e.definition.headerFilterFunc) {
            case "string":
              xe.filters[e.definition.headerFilterFunc] ? (l = e.definition.headerFilterFunc, u = function(d) {
                var c = e.definition.headerFilterFuncParams || {}, f = e.getFieldValue(d);
                return c = typeof c == "function" ? c(o, f, d) : c, xe.filters[e.definition.headerFilterFunc](o, f, d, c);
  ...
  generateHeaderFilterElement(e, t, i) {
    var s = this, n = e.modules.filter.success, o = e.getField(), a, l, h, u, d, c, f, p;
    ...
    if (e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), o) {
      ...
      if (l) {
        ...
        }, f = e.definition.headerFilterParams || {}, f = typeof f == "function" ? f.call(s.table, u) : f, h = l.call(this.table.modules.edit, u, v, n, m, f), !h) {
        ...
        s.langBind("headerFilters|columns|" + e.definition.field, function(g) {
          ...
          var R = this.table.columnManager.contentsElement.scrollLeft, L = this.table.rowManager.element.scrollLeft;
          R !== L && (this.table.rowManager.scrollHorizontal(R), this.table.columnManager.scrollHorizontal(R));
        }), d = !1, c = function(g) {
...
C(xe, "moduleName", "filter"), //load defaults
C(xe, "filters", Ah);
let us = xe;
function Ph(r, e, t) {
...
function _h(r, e, t) {
  var i = parseFloat(r.getValue()), s = "", n, o, a, l, h, u = e.decimal || ".", d = e.thousand || ",", c = e.negativeSign || "-", f = e.symbol || "", p = !!e.symbolAfter, m = typeof e.precision < "u" ? e.precision : 2;
  if (isNaN(i))
    return this.emptyToSpace(this.sanitizeHTML(r.getValue()));
  if (i < 0 && (i = Math.abs(i), s = c), n = m !== !1 ? i.toFixed(m) : i, n = String(n).split("."), o = n[0], a = n.length > 1 ? u + n[1] : "", e.thousand !== !1)
    for (l = /(\d+)(\d{3})/; l.test(o); )
      o = o.replace(l, "$1" + d + "$2");
  return h = o + a, s === !0 ? (h = "(" + h + ")", p ? h + f : f + h) : p ? s + h + f : s + f + h;
}
function Vh(r, e, t) {
  ...
  if (o) {
    if (e.urlField && (l = r.getData(), i = W.retrieveNestedData(this.table.options.nestedFieldSeparator, e.urlField, l)), e.url)
      switch (typeof e.url) {
        case "string":
          i = e.url;
          break;
...
function Zh(r, e = {}, t) {
  ...
  switch (h = parseFloat(i) <= n ? parseFloat(i) : n, h = parseFloat(h) >= o ? parseFloat(h) : o, l = (n - o) / 100, h = Math.round((h - o) / l), typeof e.color) {
    ...
    case "object":
      if (Array.isArray(e.color)) {
        let v = 100 / e.color.length, g = Math.floor(h / v);
  ...
  switch (typeof e.legendColor) {
    ...
    case "object":
      if (Array.isArray(e.legendColor)) {
        let v = 100 / e.legendColor.length, g = Math.floor(h / v);
  ...
  if (p.style.position = "relative", p.style.width = "100%", p.style.height = "100%", d) {
    ...
    m.style.position = "absolute", m.style.top = 0, m.style.left = 0, m.style.textAlign = a, m.style.width = "100%", m.style.color = c, m.innerHTML = d;
  }
  return t(function() {
    if (!(r instanceof eo)) {
    ...
    s.appendChild(p), p.appendChild(f), d && p.appendChild(m);
  }), "";
}
function Yh(r, e, t) {
...
function iu(r, e, t) {
  ...
  return e.valueMap && (typeof e.valueMap == "string" ? o = function(a) {
    return a.map((l) => W.retrieveNestedData(n.options.nestedFieldSeparator, e.valueMap, l));
...
class dt {
  ...
  //////////////// Object Generation /////////////////
  getComponent() {
    return this.component || (this.component = new ru(this)), this.component;
  }
}
class oo extends D {
  constructor(e) {
...
const Ie = class Ie extends D {
  ...
  _rebindRow(e, t) {
    this.history.forEach(function(i) {
      ...
      else if (i.component instanceof ei && i.component.row === e) {
...
C(Ie, "moduleName", "history"), C(Ie, "moduleExtensions", uu), //load defaults
C(Ie, "undoers", ou), C(Ie, "redoers", au);
let cs = Ie;
class ao extends D {
  constructor(e) {
...
C(ao, "moduleName", "htmlTableImport");
function du(r) {
  var e = [], t = 0, i = 0, s = !1;
...
const jt = class jt extends D {
  ...
  lookupImporter(e) {
    var t;
    return e || (e = this.table.options.importFormat), typeof e == "string" ? t = jt.importers[e] : t = e, t || console.error("Import Error - Importer not found:", e), t;
  }
...
C(jt, "moduleName", "import"), //load defaults
C(jt, "importers", mu);
let fs = jt;
class lo extends D {
  constructor(e) {
  ...
  dispatchEvent(e, t, i) {
    ...
    this.columnSubscribers[e] && (i instanceof ei ? n = i.column.definition[e] : i instanceof nt && (n = i.definition[e]), n && n(t, s)), this.dispatchExternal(e, t, s);
  }
}
C(lo, "moduleName", "interaction");
var gu = {
  navPrev: "shift + 9",
  navNext: 9,
  navUp: 38,
...
C(Ne, "bindings", gu), C(Ne, "actions", bu);
let ps = Ne;
class ho extends D {
  constructor(e) {
...
C(Je, "moduleName", "moveRow"), //load defaults
C(Je, "senders", vu), C(Je, "receivers", wu);
let ms = Je;
var yu = {};
const pt = class pt extends D {
  ...
  lookupMutator(e) {
    ...
    switch (typeof e) {
      case "string":
        pt.mutators[e] ? t = pt.mutators[e] : console.warn("Mutator Error - No such mutator found, ignoring: ", e);
        break;
      case "function":
        t = e;
        break;
...
C(pt, "moduleName", "mutator"), //load defaults
C(pt, "mutators", yu);
let gs = pt;
function Cu(r, e, t, i, s) {
...
const Gt = class Gt extends D {
  ...
  initializePageCounter() {
    ...
    e && (typeof e == "function" ? t = e : t = Gt.pageCounters[e], t ? (this.pageCounter = t, this.pageCounterElement = document.createElement("span"), this.pageCounterElement.classList.add("tabulator-page-counter")) : console.warn("Pagination Error - No such page counter found: ", e));
  }
  //setup pagination
...
C(Gt, "moduleName", "page"), //load defaults
C(Gt, "pageCounters", Ru);
let bs = Gt;
var Tu = {
  local: function(r, e) {
...
C(oe, "readers", Tu), C(oe, "writers", ku);
let vs = oe;
class co extends D {
  constructor(e) {
...
C(ws, "moduleName", "responsiveLayout"), C(ws, "moduleExtensions", Mu);
function Su(r, e, t) {
  ...
  if (i.type = "checkbox", i.setAttribute("aria-label", "Select Row"), this.table.modExists("selectRow", !0))
    if (i.addEventListener("click", (o) => {
      ...
      var n = r.getRow();
      n instanceof Ti ? (i.addEventListener("change", (o) => {
...
C(ys, "moduleName", "selectRow"), C(ys, "moduleExtensions", Du);
class Lu {
  constructor(e) {
...
class Ou extends X {
  ...
  ///////////////////////////////////
  layout() {
    var e = this.table.rowManager.renderer.vDomTop, t = this.table.rowManager.renderer.vDomBottom, i = this.table.columnManager.renderer.leftCol, s = this.table.columnManager.renderer.rightCol, n, o, a, l, h, u, d, c, f, p;
  ...
  getComponent() {
    return this.component || (this.component = new Lu(this)), this.component;
  }
  destroy(e) {
...
class ci extends D {
  ...
  navigate(e, t, i) {
    var s = !1, n, o, a, l, h, u, d, c, f, p, m;
    if (this.table.modules.edit && this.table.modules.edit.currentCell)
      return !1;
    if (this.ranges.length > 1 && (this.ranges = this.ranges.filter((v) => v === this.activeRange ? (v.setEnd(v.start.row, v.start.col), !0) : (v.destroy(), !1))), n = this.activeRange, a = {
      top: n.top,
      bottom: n.bottom,
      left: n.left,
      right: n.right
    ...
    if (this.rowHeader && h === 0 && (h = 1), t || n.setStart(l, h), n.setEnd(l, h), t || (this.selecting = "cell"), s = a.top !== n.top || a.bottom !== n.bottom || a.left !== n.left || a.right !== n.right, s)
      return u = this.getRowByRangePos(n.end.row), d = this.getColumnByRangePos(n.end.col), c = u.getElement().getBoundingClientRect(), p = d.getElement().getBoundingClientRect(), f = this.table.rowManager.getElement().getBoundingClientRect(), m = this.table.columnManager.getElement().getBoundingClientRect(), c.top >= f.top && c.bottom <= f.bottom || (u.getElement().parentNode && d.getElement().parentNode ? this.autoScroll(n, u.getElement(), d.getElement()) : u.getComponent().scrollTo(void 0, !1)), p.left >= m.left + this.getRowHeaderWidth() && p.right <= m.right || (u.getElement().parentNode && d.getElement().parentNode ? this.autoScroll(n, u.getElement(), d.getElement()) : d.getComponent().scrollTo(void 0, !1)), this.layoutElement(), !0;
  }
  rangeRemoved(e) {
  ...
  addRange(e, t) {
    var i;
    return this.maxRanges !== !0 && this.ranges.length >= this.maxRanges && this.ranges.shift().destroy(), i = new Ou(this.table, this, e, t), this.activeRange = i, this.ranges.push(i), this.rangeContainer.appendChild(i.element), i;
  }
  resetRanges() {
    var e, t, i;
...
C(ci, "moduleName", "selectRange"), C(ci, "moduleInitOrder", 1), C(ci, "moduleExtensions", Nu);
function _u(r, e, t, i, s, n, o) {
...
function Bu(r, e, t, i, s, n, o) {
  return o.format || (o.format = "dd/MM/yyyy"), Zs.call(this, r, e, t, i, s, n, o);
}
function Wu(r, e, t, i, s, n, o) {
  return o.format || (o.format = "HH:mm"), Zs.call(this, r, e, t, i, s, n, o);
}
function ju(r, e, t, i, s, n, o) {
  var a = r === !0 || r === "true" || r === "True" || r === 1 ? 1 : 0, l = e === !0 || e === "true" || e === "True" || e === 1 ? 1 : 0;
  return a - l;
}
function Gu(r, e, t, i, s, n, o) {
  var a = o.type || "length", l = o.alignEmptyValues, h = 0, u = this.table, d;
  o.valueMap && (typeof o.valueMap == "string" ? d = function(f) {
    return f.map((p) => W.retrieveNestedData(u.options.nestedFieldSeparator, o.valueMap, p));
  } : d = o.valueMap);
  function c(f) {
    var p;
    switch (d && (f = d(f)), a) {
...
function Uu(r, e, t, i, s, n, o) {
  var a = typeof r > "u" ? 0 : 1, l = typeof e > "u" ? 0 : 1;
  return a - l;
}
function $u(r, e, t, i, s, n, o) {
  var a, l, h, u, d = 0, c, f = /(\d+)|(\D+)/g, p = /\d/, m = o.alignEmptyValues, v = 0;
  if (!r && r !== 0)
    v = !e && e !== 0 ? 0 : -1;
  else if (!e && e !== 0)
    v = 1;
  ...
  return (m === "top" && n === "desc" || m === "bottom" && n === "asc") && (v *= -1), v;
}
var qu = {
  number: _u,
  string: Vu,
...
C(Xe, "moduleName", "sort"), //load defaults
C(Xe, "sorters", qu);
let Cs = Xe;
class Zu {
  constructor(e, t) {
...
Data:     `, e), !1;
  ...
  newSheet(e = {}) {
    var t;
    return e.rows || (e.rows = this.options("spreadsheetRows")), e.columns || (e.columns = this.options("spreadsheetColumns")), t = new zn(this, e), this.sheets.push(t), this.element && this.element.appendChild(t.element), t;
  }
  removeSheet(e) {
  ...
  lookupSheet(e) {
    return e ? e instanceof zn ? e : e instanceof vo ? e._sheet : this.sheets.find((t) => t.key === e) || !1 : this.activeSheet;
  }
  ///////////////////////////////////
  //////// Public Functions /////////
  ///////////////////////////////////
...
class yo extends D {
  ...
  loadTooltip(e, t, i) {
    ...
    typeof i == "function" && (i = i(e, t.getComponent(), a)), i instanceof HTMLElement ? s = i : (s = document.createElement("div"), i === !0 && (t instanceof ei ? i = t.value : t.definition.field ? this.langBind("columns|" + t.definition.field, (l) => {
...
const Ut = class Ut extends D {
  ...
  _buildValidator(e, t) {
    var i = typeof e == "function" ? e : Ut.validators[e];
    return i ? {
...
C(Ut, "moduleName", "validate"), //load defaults
C(Ut, "validators", Yu);
let Es = Ut;
var ji = /* @__PURE__ */ Object.freeze({
  ...
  KeybindingsModule: ps,
  MenuModule: ho,
  MoveColumnsModule: uo,
  MoveRowsModule: ms,
  MutatorModule: gs,
  PageModule: bs,
  PersistenceModule: vs,
  PopupModule: co,
  PrintModule: fo,
...
class Qu extends X {
  constructor(e) {
    super(e), this.blockHozScrollEvent = !1, this.headersElement = null, this.contentsElement = null, this.rowHeader = null, this.element = null, this.columns = [], this.columnsByIndex = [], this.columnsByField = {}, this.scrollLeft = 0, this.optionsList = new Co(this.table, "column definition", io), this.redrawBlock = !1, this.redrawBlockUpdate = null, this.renderer = null;
  }
  ////////////// Setup Functions /////////////////
  initialize() {
  ...
  _addColumn(e, t, i) {
    var s = new nt(e, this), n = s.getElement(), o = i && this.findColumnIndex(i);
...
class td extends xi {
  ...
  _virtualRenderFill(e, t, i) {
    var s = this.tableElement, n = this.elementVertical, o = 0, a = 0, l = 0, h = 0, u = 0, d = 0, c = this.rows(), f = c.length, p = 0, m, v, g = [], R = 0, L = 0, P = this.table.rowManager.fixedHeight, H = this.elementVertical.clientHeight, q = this.table.options.rowHeight, le = !0;
    if (e = e || 0, i = i || 0, !e)
      this.clear();
    else {
    ...
    if (f && W.elVisible(this.elementVertical)) {
      for (this.vDomTop = e, this.vDomBottom = e - 1, P || this.table.options.maxHeight ? (q && (L = H / q + this.vDomWindowBuffer / q), L = Math.max(this.vDomWindowMinTotalRows, Math.ceil(L))) : L = f; (L == f || a <= H + this.vDomWindowBuffer || R < this.vDomWindowMinTotalRows) && this.vDomBottom < f - 1; ) {
        for (g = [], v = document.createDocumentFragment(), d = 0; d < L && this.vDomBottom < f - 1; )
          p = this.vDomBottom + 1, m = c[p], this.styleRow(m, p), m.initialize(!1, !0), !m.heightInitialized && !this.table.options.rowHeight && m.clearCellHeight(), v.appendChild(m.getElement()), g.push(m), this.vDomBottom++, d++;
        if (!g.length)
          break;
        s.appendChild(v), g.forEach((N) => {
          N.rendered(), N.heightInitialized || N.calcHeight(!0);
        }), g.forEach((N) => {
          N.heightInitialized || N.setCellHeight();
        }), g.forEach((N) => {
          l = N.getHeight(), R < o ? u += l : a += l, l > this.vDomWindowBuffer && (this.vDomWindowBuffer = l * 2), R++;
        }), le = this.table.rowManager.adjustTableSize(), H = this.elementVertical.clientHeight, le && (P || this.table.options.maxHeight) && (q = a / R, L = Math.max(this.vDomWindowMinTotalRows, Math.ceil(H / q + this.vDomWindowBuffer / q)));
      }
      e ? (this.vDomTopPad = t ? this.vDomRowHeight * this.vDomTop + i : this.scrollTop - u, this.vDomBottomPad = this.vDomBottom == f - 1 ? 0 : Math.max(this.vDomScrollHeight - this.vDomTopPad - a - u, 0)) : (this.vDomTopPad = 0, this.vDomRowHeight = Math.floor((a + u) / R), this.vDomBottomPad = this.vDomRowHeight * (f - this.vDomBottom - 1), this.vDomScrollHeight = u + a + this.vDomBottomPad - H), s.style.paddingTop = this.vDomTopPad + "px", s.style.paddingBottom = this.vDomBottomPad + "px", t && (this.scrollTop = this.vDomTopPad + u + i - (this.elementVertical.scrollWidth > this.elementVertical.clientWidth ? this.elementVertical.offsetHeight - H : 0)), this.scrollTop = Math.min(this.scrollTop, this.elementVertical.scrollHeight - H), this.elementVertical.scrollWidth > this.elementVertical.clientWidth && t && (this.scrollTop += this.elementVertical.offsetHeight - H), this.vDomScrollPosTop = this.scrollTop, this.vDomScrollPosBottom = this.scrollTop, n.scrollTop = this.scrollTop, this.dispatch("render-virtual-fill");
    }
  }
  _addTopRow(e, t) {
...
Data:     `, e);
  ...
  addRowActual(e, t, i, s) {
    var n = e instanceof Q ? e : new Q(e || {}, this), o = this.findAddRowPos(t), a = -1, l, h;
      ...
      if (d && d.target === u)
        ...
        switch (l) {
          ...
          case "column":
            ...
            break;
          case "cell":
            s.components.includes("cell") && (n.row instanceof Q ? h = n.row.findCell(u) : t.row && console.warn("Event Target Lookup Error - The row this cell is attached to cannot be found, has the table been reinitialized without being destroyed first?"));
            break;
        }
      h && (n[l] = h, a[l] = {
        target: u,
...
function fd(r, e) {
  ...
  function f(p, m, v, g) {
    var R = [], L = 0, P = 0, H = 0, q = n, le = 0, N = 0, ne = [];
    function G(S) {
      return v * (S.column.definition.widthGrow || 1);
    }
    function he(S) {
      return c(S.width) - v * (S.column.definition.widthShrink || 0);
    }
    return p.forEach(function(S, Ue) {
      var Lt = g ? he(S) : G(S);
      S.column.minWidth >= Lt ? R.push(S) : S.column.maxWidth && S.column.maxWidth < Lt ? (S.width = S.column.maxWidth, m -= S.column.maxWidth, q -= g ? S.column.definition.widthShrink || 1 : S.column.definition.widthGrow || 1, q && (v = Math.floor(m / q))) : (ne.push(S), N += g ? S.column.definition.widthShrink || 1 : S.column.definition.widthGrow || 1);
    }), R.length ? (R.forEach(function(S) {
      L += g ? S.width - S.column.minWidth : S.column.minWidth, S.width = S.column.minWidth;
    }), P = m - L, H = N ? Math.floor(P / N) : P, le = f(ne, P, H, g)) : (le = N ? m - Math.floor(m / N) * N : m, ne.forEach(function(S) {
      S.width = g ? he(S) : G(S);
    })), le;
  }
  this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update(), this.table.rowManager.element.scrollHeight > this.table.rowManager.element.clientHeight && (t -= this.table.rowManager.element.offsetWidth - this.table.rowManager.element.clientWidth), r.forEach(function(p) {
    var m, v, g;
    p.visible && (m = p.definition.width, v = parseInt(p.minWidth), m ? (g = c(m), i += g > v ? g : v, p.definition.widthShrink && (l.push({
      column: p,
      width: g > v ? g : v
  ...
  }), s = t - i, o = Math.floor(s / n), d = f(a, s, o, !1), a.length && d > 0 && (a[a.length - 1].width += d), a.forEach(function(p) {
    s -= p.width;
  }), u = Math.abs(d) + s, u > 0 && h && (d = f(l, u, Math.floor(u / h), !0)), d && l.length && (l[l.length - 1].width -= d), a.forEach(function(p) {
...
const mt = class mt extends D {
  ...
  initialize() {
    ...
    mt.modes[e] ? this.mode = e : (console.warn("Layout Error - invalid mode set, defaulting to 'fitData' : " + e), this.mode = "fitData"), this.table.element.setAttribute("tabulator-layout", this.mode), this.subscribe("column-init", this.initializeColumn.bind(this));
  }
  initializeColumn(e) {
  ...
  layout(e) {
    ...
    this.dispatch("layout-refreshing"), mt.modes[this.mode].call(this, this.table.columnManager.columnsByIndex, e), t && this.table.rowManager.normalizeHeight(!0), this.dispatch("layout-refreshed");
  }
};
C(mt, "moduleName", "layout"), //load defaults
C(mt, "modes", pd);
let Rs = mt;
var md = {
  default: {
...
const $t = class $t extends D {
  ...
  initialize() {
    this.langList = W.deepClone($t.langs), this.table.options.columnDefaults.headerFilterPlaceholder !== !1 && this.setHeaderFilterPlaceholder(this.table.options.columnDefaults.headerFilterPlaceholder);
...
C($t, "moduleName", "localize"), //load defaults
C($t, "langs", md);
let Ts = $t;
class Eo extends D {
  constructor(e) {
...
C(ce, "registry", {
  ...
  lookupTable(e, t) {
    ...
    } else typeof HTMLElement < "u" && e instanceof HTMLElement || e instanceof ce ? (n = ce.registry.matchElement(e), n && i.push(n)) : Array.isArray(e) ? e.forEach(function(a) {
...
let ks = ce;
const B = class B extends ks {
  constructor() {
    super();
  }
  static initializeModuleBinder(e) {
    B.modulesRegistered || (B.modulesRegistered = !0, B._registerModules(gd, !0), e && B._registerModules(e));
  }
...
C(B, "moduleBindings", {}), C(B, "moduleExtensions", {}), C(B, "modulesRegistered", !1), C(B, "defaultModules", !1);
let xs = B;
class bd extends X {
  constructor(e) {
...
const Me = class Me extends xs {
  ...
  initializeCoreSystems(e) {
    this.columnManager = new Qu(this), this.rowManager = new id(this), this.footerManager = new sd(this), this.dataLoader = new od(this), this.alertManager = new bd(this), this._bindModules(), this.options = this.optionsList.generate(Me.defaultOptions, e), this._clearObjectPointers(), this._mapDeprecatedFunctionality(), this.externalEvents = new ad(this, this.options, this.options.debugEventsExternal), this.eventBus = new ld(this.options.debugEventsInternal), this.interactionMonitor = new nd(this), this.dataLoader.initialize(), this.footerManager.initialize(), this.dependencyRegistry.initialize();
  }
...
C(Me, "defaultOptions", Ju);
let Ms = Me;
var Ht = Ms;
class vd extends Ht {
  static extendModule() {
    Ht.initializeModuleBinder(ji), Ht._extendModule(...arguments);
  }
  static registerModule() {
    Ht.initializeModuleBinder(ji), Ht._registerModule(...arguments);
  }
  constructor(e, t, i) {
    super(e, t, ji);
  }
...
var wd = vd, Ys = class {
  ...
  setTimeoutProvider(r) {
    process.env.NODE_ENV !== "production" && w(this, Qe) && r !== w(this, Te) && console.error(
      "[timeoutManager]: Switching provider after calls to previous provider might result in unexpected behavior.",
      { previous: w(this, Te), provider: r }
    ), O(this, Te, r), process.env.NODE_ENV !== "production" && O(this, Qe, !1);
  }
  setTimeout(r, e) {
    return process.env.NODE_ENV !== "production" && O(this, Qe, !0), w(this, Te).setTimeout(r, e);
  }
  clearTimeout(r) {
    w(this, Te).clearTimeout(r);
  }
  setInterval(r, e) {
    return process.env.NODE_ENV !== "production" && O(this, Qe, !0), w(this, Te).setInterval(r, e);
  }
  clearInterval(r) {
    w(this, Te).clearInterval(r);
  }
}, Te = new WeakMap(), Qe = new WeakMap(), Un), li = new Cd();
function Ed(r) {
  setTimeout(r, 0);
}
var vi = typeof window > "u" || "Deno" in globalThis;
function Rd() {
}
function An(r) {
...
function In(r) {
  ...
  if (e === void 0)
    return !0;
  const t = e.prototype;
  return !(!Nn(t) || !t.hasOwnProperty("isPrototypeOf") || Object.getPrototypeOf(r) !== Object.prototype);
}
function Nn(r) {
...
var et, Ve, vt, $n, xd = ($n = class extends Ys {
  constructor() {
    super();
    j(this, et);
    j(this, Ve);
  ...
  onSubscribe() {
    w(this, Ve) || this.setEventListener(w(this, vt));
  }
  onUnsubscribe() {
    var e;
    this.hasListeners() || ((e = w(this, Ve)) == null || e.call(this), O(this, Ve, void 0));
  }
  setEventListener(e) {
    var t;
    O(this, vt, e), (t = w(this, Ve)) == null || t.call(this), O(this, Ve, e((i) => {
      typeof i == "boolean" ? this.setFocused(i) : this.onFocus();
    }));
  }
  setFocused(e) {
    w(this, et) !== e && (O(this, et, e), this.onFocus());
  }
  onFocus() {
  ...
  isFocused() {
    var e;
    return typeof w(this, et) == "boolean" ? w(this, et) : ((e = globalThis.document) == null ? void 0 : e.visibilityState) !== "hidden";
  }
}, et = new WeakMap(), Ve = new WeakMap(), vt = new WeakMap(), $n), Md = new xd();
function Bn() {
  let r, e;
...
var Ld = Dd(), wt, Be, yt, qn, Od = (qn = class extends Ys {
  constructor() {
    super();
    j(this, wt, !0);
    j(this, Be);
  ...
  onSubscribe() {
    w(this, Be) || this.setEventListener(w(this, yt));
  }
  onUnsubscribe() {
    var e;
    this.hasListeners() || ((e = w(this, Be)) == null || e.call(this), O(this, Be, void 0));
  }
  setEventListener(e) {
    var t;
    O(this, yt, e), (t = w(this, Be)) == null || t.call(this), O(this, Be, e(this.setOnline.bind(this)));
  }
  setOnline(e) {
    w(this, wt) !== e && (O(this, wt, e), this.listeners.forEach((i) => {
      i(e);
    }));
  }
  isOnline() {
...
}, wt = new WeakMap(), Be = new WeakMap(), yt = new WeakMap(), qn), Fd = new Od();
function zd(r) {
  return (r ?? "online") === "online" ? Fd.isOnline() : !0;
}
function Hd(r, e) {
  return {
    fetchFailureCount: 0,
    fetchFailureReason: null,
    fetchStatus: zd(e.networkMode) ? "fetching" : "paused",
    ...r === void 0 && {
      error: null,
      status: "pending"
    }
...
var ae, F, Zt, ie, tt, Ct, Se, We, Yt, Et, Rt, it, st, je, Tt, V, _t, Ls, Os, Fs, zs, Hs, As, Ps, Ro, Zn, Ad = (Zn = class extends Ys {
  constructor(e, t) {
    super();
    j(this, V);
    j(this, ae);
    ...
    this.options = t, O(this, ae, e), O(this, We, null), O(this, Se, Bn()), this.bindMethods(), this.setOptions(t);
  }
  bindMethods() {
    this.refetch = this.refetch.bind(this);
  }
  onSubscribe() {
    this.listeners.size === 1 && (w(this, F).addObserver(this), Wn(w(this, F), this.options) ? Z(this, V, _t).call(this) : this.updateResult(), Z(this, V, zs).call(this));
  }
  onUnsubscribe() {
  ...
  destroy() {
    this.listeners = /* @__PURE__ */ new Set(), Z(this, V, Hs).call(this), Z(this, V, As).call(this), w(this, F).removeObserver(this);
  }
  setOptions(e) {
    const t = this.options, i = w(this, F);
    if (this.options = w(this, ae).defaultQueryOptions(e), this.options.enabled !== void 0 && typeof this.options.enabled != "boolean" && typeof this.options.enabled != "function" && typeof ye(this.options.enabled, w(this, F)) != "boolean")
      throw new Error(
        "Expected enabled to be a boolean or a callback that returns a boolean"
      );
    Z(this, V, Ps).call(this), w(this, F).setOptions(this.options), t._defaulted && !Ds(this.options, t) && w(this, ae).getQueryCache().notify({
    ...
    s && jn(
      ...
      this.options,
      t
    ) && Z(this, V, _t).call(this), this.updateResult(), s && (w(this, F) !== i || ye(this.options.enabled, w(this, F)) !== ye(t.enabled, w(this, F)) || Bt(this.options.staleTime, w(this, F)) !== Bt(t.staleTime, w(this, F))) && Z(this, V, Ls).call(this);
    const n = Z(this, V, Os).call(this);
    s && (w(this, F) !== i || ye(this.options.enabled, w(this, F)) !== ye(t.enabled, w(this, F)) || n !== w(this, je)) && Z(this, V, Fs).call(this, n);
  }
  getOptimisticResult(e) {
    const t = w(this, ae).getQueryCache().build(w(this, ae), e), i = this.createResult(t, e);
    return Id(this, i) && (O(this, ie, i), O(this, Ct, this.options), O(this, tt, w(this, F).state)), i;
  }
  getCurrentResult() {
    return w(this, ie);
  }
  trackResult(e, t) {
    return new Proxy(e, {
      get: (i, s) => (this.trackProp(s), t == null || t(s), s === "promise" && (this.trackProp("data"), !this.options.experimental_prefetchInRender && w(this, Se).status === "pending" && w(this, Se).reject(
        new Error(
  ...
  fetchOptimistic(e) {
    const t = w(this, ae).defaultQueryOptions(e), i = w(this, ae).getQueryCache().build(w(this, ae), t);
  ...
  fetch(e) {
    ...
    }).then(() => (this.updateResult(), w(this, ie)));
  }
  createResult(e, t) {
    var ne;
    const i = w(this, F), s = this.options, n = w(this, ie), o = w(this, tt), a = w(this, Ct), h = e !== i ? e.state : w(this, Zt), { state: u } = e;
    let d = { ...u }, c = !1, f;
    if (t._optimisticResults) {
      const G = this.hasListeners(), he = !G && Wn(e, t), S = G && jn(e, i, t, s);
      (he || S) && (d = {
        ...d,
        ...Hd(u.data, e.options)
      }), t._optimisticResults === "isRestoring" && (d.fetchStatus = "idle");
    }
    let { error: p, errorUpdatedAt: m, status: v } = d;
    f = d.data;
    let g = !1;
    if (t.placeholderData !== void 0 && f === void 0 && v === "pending") {
      let G;
      n != null && n.isPlaceholderData && t.placeholderData === (a == null ? void 0 : a.placeholderData) ? (G = n.data, g = !0) : G = typeof t.placeholderData == "function" ? t.placeholderData(
        (ne = w(this, Rt)) == null ? void 0 : ne.state.data,
        w(this, Rt)
      ) : t.placeholderData, G !== void 0 && (v = "success", f = _n(
    ...
    if (t.select && f !== void 0 && !g)
      if (n && f === (o == null ? void 0 : o.data) && t.select === w(this, Yt))
        f = w(this, Et);
      else
        try {
          O(this, Yt, t.select), f = t.select(f), f = _n(n == null ? void 0 : n.data, f, t), O(this, Et, f), O(this, We, null);
        } catch (G) {
          O(this, We, G);
        }
    w(this, We) && (p = w(this, We), f = w(this, Et), m = Date.now(), v = "error");
    const R = d.fetchStatus === "fetching", L = v === "pending", P = v === "error", H = L && R, q = f !== void 0, N = {
      status: v,
    ...
    if (this.options.experimental_prefetchInRender) {
      const G = (Ue) => {
        N.status === "error" ? Ue.reject(N.error) : N.data !== void 0 && Ue.resolve(N.data);
      }, he = () => {
        const Ue = O(this, Se, N.promise = Bn());
        G(Ue);
      }, S = w(this, Se);
      switch (S.status) {
        case "pending":
          e.queryHash === i.queryHash && G(S);
          break;
        case "fulfilled":
          (N.status === "error" || N.data !== S.value) && he();
          break;
        case "rejected":
          (N.status !== "error" || N.error !== S.reason) && he();
          break;
      }
    }
    return N;
  ...
  updateResult() {
    const e = w(this, ie), t = this.createResult(w(this, F), this.options);
    if (O(this, tt, w(this, F).state), O(this, Ct, this.options), w(this, tt).data !== void 0 && O(this, Rt, w(this, F)), Ds(t, e))
      return;
    O(this, ie, t);
    const i = () => {
      if (!e)
      ...
      if (n === "all" || !n && !w(this, Tt).size)
        return !0;
      const o = new Set(
        n ?? w(this, Tt)
      );
      return this.options.throwOnError && o.add("error"), Object.keys(w(this, ie)).some((a) => {
        const l = a;
        return w(this, ie)[l] !== e[l] && o.has(l);
      });
    };
    Z(this, V, Ro).call(this, { listeners: i() });
  }
  onQueryUpdate() {
    this.updateResult(), this.hasListeners() && Z(this, V, zs).call(this);
  }
}, ae = new WeakMap(), F = new WeakMap(), Zt = new WeakMap(), ie = new WeakMap(), tt = new WeakMap(), Ct = new WeakMap(), Se = new WeakMap(), We = new WeakMap(), Yt = new WeakMap(), Et = new WeakMap(), Rt = new WeakMap(), it = new WeakMap(), st = new WeakMap(), je = new WeakMap(), Tt = new WeakMap(), V = new WeakSet(), _t = function(e) {
  Z(this, V, Ps).call(this);
  let t = w(this, F).fetch(
    this.options,
    e
  );
  return e != null && e.throwOnError || (t = t.catch(Rd)), t;
}, Ls = function() {
  Z(this, V, Hs).call(this);
  const e = Bt(
    this.options.staleTime,
    w(this, F)
  );
  if (vi || w(this, ie).isStale || !An(e))
    return;
  const i = Td(w(this, ie).dataUpdatedAt, e) + 1;
  O(this, it, li.setTimeout(() => {
    w(this, ie).isStale || this.updateResult();
  }, i));
}, Os = function() {
  return (typeof this.options.refetchInterval == "function" ? this.options.refetchInterval(w(this, F)) : this.options.refetchInterval) ?? !1;
}, Fs = function(e) {
  Z(this, V, As).call(this), O(this, je, e), !(vi || ye(this.options.enabled, w(this, F)) === !1 || !An(w(this, je)) || w(this, je) === 0) && O(this, st, li.setInterval(() => {
    (this.options.refetchIntervalInBackground || Md.isFocused()) && Z(this, V, _t).call(this);
  }, w(this, je)));
}, zs = function() {
  Z(this, V, Ls).call(this), Z(this, V, Fs).call(this, Z(this, V, Os).call(this));
}, Hs = function() {
  w(this, it) && (li.clearTimeout(w(this, it)), O(this, it, void 0));
}, As = function() {
  w(this, st) && (li.clearInterval(w(this, st)), O(this, st, void 0));
}, Ps = function() {
  const e = w(this, ae).getQueryCache().build(w(this, ae), this.options);
  if (e === w(this, F))
    return;
  const t = w(this, F);
  O(this, F, e), O(this, Zt, e.state), this.hasListeners() && (t == null || t.removeObserver(this), e.addObserver(this));
}, Ro = function(e) {
  Ld.batch(() => {
...
function Wn(r, e) {
  return Pd(r, e) || r.state.data !== void 0 && Is(r, e, e.refetchOnMount);
}
function Is(r, e, t) {
  if (ye(e.enabled, r) !== !1 && Bt(e.staleTime, r) !== "static") {
    const i = typeof t == "function" ? t(r) : t;
    return i === "always" || i !== !1 && Js(r, e);
  }
  return !1;
}
function jn(r, e, t, i) {
  return (r !== e || ye(i.enabled, r) === !1) && (!t.suspense || r.state.status !== "error") && Js(r, t);
}
function Js(r, e) {
  return ye(e.enabled, r) !== !1 && r.isStaleByTime(Bt(e.staleTime, r));
}
function Id(r, e) {
  return !Ds(r.getCurrentResult(), e);
}
var Nd = "VUE_QUERY_CLIENT";
function _d(r) {
  const e = r ? `:${r}` : "";
  return `${Nd}${e}`;
}
...
function Ns(r, e, t = "", i = 0) {
  if (e) {
    const s = e(r, t, i);
    if (s === void 0 && Yn(r) || s !== void 0)
      return s;
  }
  if (Array.isArray(r))
    return r.map(
      (s, n) => Ns(s, e, String(n), i + 1)
    );
  if (typeof r == "object" && Bd(r)) {
...
function jd(r, e, t) {
  process.env.NODE_ENV === "development" && (_o() || console.warn(
  ...
  const i = To(), s = Jn(() => {
    ...
    const p = i.defaultQueryOptions(f);
    return p._optimisticResults = (m = i.isRestoring) != null && m.value ? "isRestoring" : "optimistic", p;
  }), n = new r(i, s.value), o = s.value.shallow ? Vo(n.getCurrentResult()) : Bo(n.getCurrentResult());
  let a = () => {
  };
  i.isRestoring && ht(
    i.isRestoring,
  ...
  const l = () => {
    n.setOptions(s.value), Gn(o, n.getCurrentResult());
  };
  ht(s, l), Wo(() => {
    a();
  });
    ...
    (f, p) => {
      ...
      const v = () => {
        if (s.value.enabled !== !1) {
          ...
          g.isStale ? (m(), n.fetchOptimistic(s.value).then(f, (R) => {
            Vn(s.value.throwOnError, [
              R,
              n.getCurrentQuery()
            ]) ? p(R) : f(n.getCurrentResult());
          })) : (m(), f(g));
        }
      };
      v(), m = ht(s, v);
  ...
  ht(
    () => o.error,
    (f) => {
      if (o.isError && !o.isFetching && Vn(s.value.throwOnError, [
        f,
        n.getCurrentQuery()
      ]))
        throw f;
  ...
  const d = s.value.shallow ? jo(o) : Go(o), c = Uo(d);
  for (const f in o)
...
const Ud = Symbol.for("y2kfund.supabase"), $d = {
...
function Yd(r, e) {
  const t = qd(), i = $d.cashTransactions(r), s = To(), n = Gd({
    queryKey: i,
    queryFn: async () => {
      var a, l;
      const h = await Zd(t, e);
      ...
      const u = await t.schema("hf").from("cash_transaction").select("fetched_at").order("fetched_at", { ascending: !1 }).limit(1);
      if (u.error)
      ...
      let c = t.schema("hf").from("cash_transaction").select(`
          id,
          internal_account_id,
          fetched_at,
          "accountId",
          ...
          weight
        `).eq("fetched_at", d);
      h.length > 0 ? (console.log("🔒 Applying access filter for accounts:", h), c = c.in("internal_account_id", h)) : console.log("🔓 No access filter applied - showing all cash transactions"), c = c.order('"dateTime"', { ascending: !1 });
      ...
      if (f.error)
        throw console.error("❌ Cash transactions query error:", f.error), f.error;
      if (p.error)
        throw console.error("❌ Accounts query error:", p.error), p.error;
      console.log("✅ Cash transactions query success:", {
        latestFetchedAt: d,
        cashTransactionsCount: (a = f.data) == null ? void 0 : a.length,
        accountsCount: (l = p.data) == null ? void 0 : l.length,
        filtered: h.length > 0,
      ...
      return (f.data || []).map((R) => {
        let L = v.get(R.internal_account_id) || void 0;
        return g.has(R.internal_account_id) && (L = g.get(R.internal_account_id)), {
          ...R,
          legal_entity: L
        };
      });
    ...
    staleTime: 6e4
  }), o = t.channel(`cash_transaction:${r}`).on(
    "postgres_changes",
    {
      schema: "hf",
      table: "cash_transaction",
...
const Jd = { class: "cash-transactions-card" }, Xd = { class: "toast-container" }, Kd = { key: 0 }, Qd = ["onClick"], ec = {
  key: 0,
  class: "loading"
}, tc = {
  key: 1,
  ...
  key: 2,
  class: "cash-transactions-container"
}, sc = { class: "cash-transactions-header" }, nc = { key: 1 }, rc = { class: "cash-transactions-tools" }, oc = { class: "columns-content" }, ac = ["value"], lc = { class: "column-label" }, hc = { class: "columns-footer" }, uc = {
  key: 0,
  class: "filters-bar"
}, dc = { class: "filters-tags" }, cc = ["onClick"], fc = {
  key: 3,
  class: "rename-dialog-backdrop"
}, pc = { class: "rename-dialog" }, mc = { class: "dialog-actions" }, gc = /* @__PURE__ */ $o({
  __name: "CashTransactions",
  props: {
    accountId: { default: "1" },
    highlightPnL: { type: Boolean },
    onRowClick: {},
  ...
  setup(r, { emit: e }) {
    window.luxon = { DateTime: k };
    const t = r, i = e, s = _s("eventBus"), n = de(null), o = de([]);
    function a() {
      if (!(!m || !v.value))
        try {
          m.clearFilter(!0), m.setFilter((y) => !(!y || n.value && (typeof y.legal_entity == "object" && y.legal_entity !== null ? y.legal_entity.name || y.legal_entity.id : y.legal_entity) !== n.value)), l(), ii(() => {
            m && m.redraw();
          });
        } catch (y) {
    ...
    function l() {
      const y = [];
      n.value && y.push({ field: "legal_entity", value: n.value }), o.value = y;
    }
    const h = de([]);
    let u = 0;
    function d(y, b, M) {
      const x = u++;
      h.value.push({ id: x, type: y, title: b, message: M }), setTimeout(() => c(x), 5e3);
    }
    function c(y) {
      const b = h.value.findIndex((M) => M.id === y);
      b !== -1 && h.value.splice(b, 1);
    }
    const f = Yd(t.accountId, t.userId), p = de(null);
    let m = null;
    const v = de(!1), g = de(!1), R = de("Cash Transactions"), L = de(!1), P = de("");
    function H() {
      P.value = R.value, L.value = !0;
    }
    function q() {
      R.value = P.value.trim() || "Cash Transactions", L.value = !1;
    }
    function le() {
      return [
        {
        ...
        },
        {
          ...
          action: (y, b) => {
            const x = b.getData().fetched_at;
            x ? navigator.clipboard.writeText(x).then(() => {
              d("success", "Copied!", "Timestamp copied to clipboard");
            }).catch((J) => {
              console.error("Failed to copy:", J), d("error", "Copy Failed", "Could not copy timestamp");
            }) : d("warning", "No Data", "No timestamp available to copy");
          }
        }
      ];
    }
    function N(y) {
      ...
      try {
        const b = new Date(y), M = Intl.DateTimeFormat().resolvedOptions().timeZone, J = {
          "Asia/Kolkata": "IST",
          "Asia/Calcutta": "IST",
        ...
        }[M] || M, Re = b.toLocaleDateString("en-US", {
          month: "short",
          day: "numeric",
          year: "numeric",
          timeZone: M
        }), ue = b.toLocaleTimeString("en-US", {
          hour: "2-digit",
          minute: "2-digit",
          second: "2-digit",
          hour12: !0,
        ...
        return `⏱️ Last Updated: ${Re} at ${ue} ${J}`;
      } catch {
    ...
    function ne(y) {
      if (y === "legal_entity") {
        ...
        b.searchParams.delete("all_cts_clientId"), window.history.replaceState({}, "", b.toString()), s && s.emit("account-filter-changed", {
          accountId: null,
    ...
    function G() {
      ...
      y.searchParams.delete("all_cts_clientId"), y.searchParams.delete("all_cts_fi"), y.searchParams.delete("all_cts_asset"), y.searchParams.delete("all_cts_qty"), window.history.replaceState({}, "", y.toString()), s && s.emit("account-filter-changed", { accountId: null, source: "cash-transactions" }), a();
    }
    const he = [
    ...
    ], S = de(he.map((y) => y.field)), Ue = Jn(() => [
      {
        ...
        cellClick: (y, b) => {
          const M = b.getValue(), x = typeof M == "object" && M !== null ? M.name || M.id : M;
          ko("legal_entity", x);
        },
        contextMenu: le()
      },
      {
        ...
        field: "dateTime",
        minWidth: 120,
        sorter: (y, b, M, x, J, Re, ue) => {
          const $e = (Xs) => Xs ? String(Xs).split(";")[0].trim() : "", Si = $e(y), zo = $e(b), Ho = Ot(Si) || 0, Ao = Ot(zo) || 0;
          return Ho - Ao;
        },
        formatter: (y) => {
          let b = y.getValue();
          if (!b) return "";
          b = String(b).split(";")[0].trim();
          const M = /^(\d{1,2})\/(\d{1,2})\/(\d{2,4})$/.exec(b);
          let x;
          if (M) {
            const J = Number(M[1]), Re = Number(M[2]) - 1;
            let ue = Number(M[3]);
            ue < 100 && (ue += 2e3), x = new Date(ue, Re, J);
          } else if (x = new Date(b), isNaN(x.getTime())) return String(b);
      ...
      },
      {
        ...
        formatter: (y) => {
          ...
          if (!b) return "";
          const M = Ot(b);
          return M ? new Date(M).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }) : b;
        }
      },
      {
        title: "Amount",
        ...
        formatter: (y) => `<span style="font-weight: 600;">${Lt(parseFloat(y.getValue()) || 0)}</span>`,
        bottomCalc: "sum",
        bottomCalcFormatter: (y) => Lt(y.getValue() || 0),
        contextMenu: le()
      },
      {
        title: "Description",
    ...
    ].filter((y) => S.value.includes(y.field)));
    function Lt(y) {
      return new Intl.NumberFormat("en-US", { style: "currency", currency: "USD", maximumFractionDigits: 2 }).format(y);
    }
    function Ot(y) {
      if (!y) return null;
      const b = String(y).trim(), M = /^([0-9]{1,2})\/([0-9]{1,2})\/([0-9]{2,4})$/.exec(b);
      if (M) {
        let J = Number(M[1]), Re = Number(M[2]) - 1, ue = Number(M[3]);
        ue < 100 && (ue += 2e3);
        const $e = new Date(ue, Re, J);
        return isNaN($e.getTime()) ? null : $e.getTime();
      }
      const x = new Date(b);
      return isNaN(x.getTime()) ? null : x.getTime();
    }
    function ko(y, b) {
      {
        if (n.value === b) {
          ...
          M.searchParams.delete("all_cts_clientId"), window.history.replaceState({}, "", M.toString()), s && s.emit("account-filter-changed", {
            accountId: null,
            source: "cash-transactions"
          });
        } else {
          n.value = b;
          const M = new URL(window.location.href);
          M.searchParams.set("all_cts_clientId", b), window.history.replaceState({}, "", M.toString()), s && s.emit("account-filter-changed", {
            accountId: b,
            source: "cash-transactions"
          });
        }
    ...
    const ti = de(!1), xo = de(null), Mo = de(null);
    function So() {
      ti.value = !ti.value;
    }
    function Do() {
    ...
    function Mi() {
      if (p.value) {
        ...
        }), m.on("tableBuilt", function() {
          v.value = !0, a();
        });
      }
    }
    function Lo() {
      return new URL(window.location.href).searchParams.get("cash_transactions_app_name") || "Cash Transactions";
    }
    function Oo() {
      const y = new URL(window.location.href), b = y.searchParams.get("all_cts_clientId") || void 0, M = y.searchParams.get("all_cts_fi") || void 0, x = M ? M.split(",").filter(Boolean) : void 0, J = y.searchParams.get("all_cts_asset") || void 0, Re = y.searchParams.get("all_cts_qty") || void 0, ue = Re ? Number(Re) : void 0;
      return { legal_entity: b, symbol: x, asset: J, quantity: ue };
    }
    function Fo(y) {
      if (console.log("📍 [Cash Transactions] Received account filter:", y), y.source === "cash-transactions") return;
      n.value = y.accountId;
      const b = new URL(window.location.href);
      y.accountId ? b.searchParams.set("all_cts_clientId", y.accountId) : b.searchParams.delete("all_cts_clientId"), window.history.replaceState({}, "", b.toString()), a();
    }
    return ht([() => f.isSuccess.value, p, S], async ([y, b]) => {
      y && b && !g.value ? (await ii(), Mi(), g.value = !0) : y && b && g.value && (await ii(), Mi());
    }, { immediate: !0 }), ht(() => f.data.value, async (y) => {
      if (!(!m || !y))
        try {
          m.replaceData(y), a();
        } catch (b) {
      ...
      R.value = Lo();
      const y = Oo();
      y.legal_entity && (n.value = y.legal_entity), f.isSuccess.value && p.value && !g.value && (await ii(), Mi(), g.value = !0), a(), s && s.on("account-filter-changed", Fo);
    }), Zo(() => {
      var y;
      if (m) {
        try {
      ...
      (y = f._cleanup) == null || y.call(f);
    }), (y, b) => {
      const M = Yo("router-link");
      return te(), re("div", Jd, [
        z("div", Xd, [
          (te(!0), re(Li, null, Oi(h.value, (x) => (te(), re("div", {
            key: x.id,
            class: Jo(["toast", `toast-${x.type}`])
          }, [
            z("strong", null, Le(x.title), 1),
            x.message ? (te(), re("span", Kd, Le(x.message), 1)) : Ft("", !0),
            z("button", {
              onClick: (J) => c(x.id),
              class: "toast-close"
            }, "×", 8, Qd)
        ...
        At(f).isLoading.value ? (te(), re("div", ec, [...b[5] || (b[5] = [
          z("div", { class: "loading-spinner" }, null, -1),
          Fi(" Loading cash transactions... ", -1)
        ])])) : At(f).isError.value ? (te(), re("div", tc, [
          b[6] || (b[6] = z("h3", null, "Error loading cash transactions", -1)),
          z("p", null, Le(At(f).error.value), 1)
        ])) : At(f).isSuccess.value ? (te(), re("div", ic, [
          z("div", sc, [
            z("h2", null, [
              r.showHeaderLink ? (te(), Xo(M, {
                key: 0,
            ...
            z("div", rc, [
              z("button", {
                ref_key: "cashTransactionsColumnsBtnRef",
                ref: xo,
                class: "filter-btn",
              ...
              ti.value ? (te(), re("div", {
                key: 0,
                ref_key: "cashTransactionsColumnsPopupRef",
                ref: Mo,
                class: "columns-dropdown",
                onClick: b[2] || (b[2] = Qs(() => {
                }, ["stop"]))
              }, [
                b[8] || (b[8] = z("div", { class: "columns-header" }, [
                  z("span", { class: "columns-title" }, "Columns")
                ], -1)),
                z("div", oc, [
                  (te(), re(Li, null, Oi(he, (x) => z("label", {
                    key: x.field,
                    class: "column-option"
                  }, [
                    en(z("input", {
                      type: "checkbox",
                      value: x.field,
                      "onUpdate:modelValue": b[0] || (b[0] = (J) => S.value = J),
                      class: "column-checkbox"
                    }, null, 8, ac), [
                      [Qo, S.value]
                    ]),
                    z("span", lc, Le(x.label), 1)
                  ])), 64))
                ]),
                z("div", hc, [
                  z("button", {
                    class: "btn-link",
                    onClick: b[1] || (b[1] = (x) => S.value = he.map((J) => J.field))
                  }, " Show All "),
                  z("button", {
                    class: "btn-done",
                    onClick: Do
          ...
          o.value.length ? (te(), re("div", uc, [
            b[9] || (b[9] = z("span", { class: "filters-label" }, "Filtered by:", -1)),
            z("div", dc, [
              (te(!0), re(Li, null, Oi(o.value, (x) => (te(), re("span", {
                key: `${x.field}-${x.value}`,
                class: "filter-tag"
              }, [
                z("strong", null, Le(x.field === "legal_entity" ? "Account" : x.field === "symbol" ? "Symbol" : x.field === "assetCategory" ? "Asset Class" : x.field === "quantity" ? "Quantity" : "Unknown") + ":", 1),
                Fi(" " + Le(x.value) + " ", 1),
                z("button", {
                  class: "tag-clear",
                  onClick: (J) => ne(x.field)
                }, "✕", 8, cc)
              ]))), 128)),
              z("button", {
                class: "btn-clear-all",
          ...
          z("div", {
            ref_key: "tableDiv",
            ref: p,
            class: "cash-transactions-grid"
          }, null, 512)
        ])) : Ft("", !0),
        L.value ? (te(), re("div", fc, [
          z("div", pc, [
            b[10] || (b[10] = z("h3", null, "Rename App", -1)),
            en(z("input", {
              "onUpdate:modelValue": b[3] || (b[3] = (x) => P.value = x),
              placeholder: "App name"
            }, null, 512), [
              [ea, P.value]
            ]),
            z("div", mc, [
              z("button", { onClick: q }, "Save"),
              z("button", {
                onClick: b[4] || (b[4] = (x) => L.value = !1)
              }, "Cancel")
            ])
          ])
        ])) : Ft("", !0)
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Cc = /* @__PURE__ */ bc(gc, [["__scopeId", "data-v-10524097"]]);
export {
  Cc as CashTransactions,
  Cc as default
};
